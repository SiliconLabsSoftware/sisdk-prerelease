...
#elif defined(SLDK4360A_SIWG353) || defined(SLDK6360A_SIWG353)
// ADC input on PA2 (port A), loopback output on PA3 (port A).
#define ADC0_IN_GPIO_PORT     SL_HAL_ADC_PORT_POS_PORTA
#define ADC0_IN_GPIO_PIN      2
#define GPIO_ADC0_PORT        SL_GPIO_PORT_A
#define GPIO_ADC0_PIN         2
#define GPIO_OUT_PORT         SL_GPIO_PORT_A
#define GPIO_OUT_PIN          3
#else
...
#if defined(SLDK4360A_SIWG353) || defined(SLDK6360A_SIWG353)
  // ADC input is on port A (PA2), which is routed through the A/B analog bus.
  GPIO->ABUSALLOC_SET = _GPIO_ABUSALLOC_AEVEN0_ADC0;
  GPIO->ABUSALLOC_SET = _GPIO_ABUSALLOC_AODD0_ADC0;
#else
  // ADC input is on port C/D, routed through the C/D analog bus.
