/***************************************************************************//**
 * @file
 * @brief spidrv slave FreeRTOS examples functions
 *******************************************************************************
 * # License
 ...
 ******************************************************************************/
 #include <string.h>
#include <stdio.h>
#include "spidrv_slave_freertos.h"
#include "spidrv.h"
...
static void spidrv_app_task(void *pvParameters)
{
  ...
  while (1) {
    ...
    // Non-blocking data transfer to master. When complete, rx buffer will be filled.
    Ecode_t ecode = SPIDRV_STransfer(SPI_HANDLE, tx_buffer, rx_buffer, APP_BUFFER_SIZE, transfer_callback, 0);
