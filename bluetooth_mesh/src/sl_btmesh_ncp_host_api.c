/***************************************************************************//**
 * @brief SL_BTMESH_API commands for NCP host
 *******************************************************************************
 * # License
...
sl_status_t sl_btmesh_node_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_init_command_id,
...
sl_status_t sl_btmesh_node_set_exportable_keys(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_set_exportable_keys_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_node_start_unprov_beaconing(uint8_t bearer)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_start_unprov_beaconing_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_start_unprov_beaconing_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_node_stop_unprov_beaconing(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_stop_unprov_beaconing_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_node_get_rssi(int8_t *rssi)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_get_rssi_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                           ...
                                                           const uint8_t* data)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_send_input_oob_request_response_t) + data_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_send_input_oob_request_response_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_node_get_uuid(uuid_128 *uuid)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_get_uuid_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                 ...
                                                 uint8_t kr_in_progress)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_set_provisioning_data_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_set_provisioning_data_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                    ...
                                    uint16_t oob_location)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_init_oob_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_init_oob_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_node_set_ivrecovery_mode(uint8_t mode)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_set_ivrecovery_mode_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_set_ivrecovery_mode_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_node_get_ivrecovery_mode(uint8_t *mode)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_get_ivrecovery_mode_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_node_set_net_relay_delay(uint8_t min_ms, uint8_t max_ms)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_set_net_relay_delay_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_set_net_relay_delay_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               uint8_t *max_ms)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_get_net_relay_delay_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                              ...
                                              uint8_t *state)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_get_ivupdate_state_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_node_request_ivupdate(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_request_ivupdate_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                             ...
                                             uint32_t *count)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_get_seq_remaining_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_get_seq_remaining_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_node_save_replay_protection_list(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_save_replay_protection_list_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_node_set_uuid(uuid_128 uuid)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_set_uuid_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_set_uuid_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                             ...
                                                             uint16_t *unsaved_entries)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_get_replay_protection_list_status_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                               ...
                                               uint16_t *address)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_get_element_address_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_get_element_address_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                            ...
                                                            const uint8_t* data)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_send_static_oob_request_response_t) + data_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_send_static_oob_request_response_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_node_reset(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_reset_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_node_set_beacon_reporting(uint8_t report)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_set_beacon_reporting_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_set_beacon_reporting_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_node_set_iv_update_age(uint32_t age_sec)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_set_iv_update_age_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_set_iv_update_age_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_node_get_key_count(uint8_t type, uint32_t *count)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_get_key_count_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_get_key_count_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                   ...
                                   aes_key_128 *key)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_get_key_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_get_key_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                            ...
                                                            uint8_t *networks)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_get_networks_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                              ...
                                              uint32_t *seqnum)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_get_element_seqnum_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_get_element_seqnum_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                            ...
                                            uint32_t value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_set_model_option_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_set_model_option_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_node_get_local_dcd(uint8_t page)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_get_local_dcd_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_get_local_dcd_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_node_power_off(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_power_off_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_node_set_adv_phy(uint8_t phy)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_set_adv_phy_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_set_adv_phy_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_node_get_adv_phy(uint8_t *phy)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_get_adv_phy_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_node_set_provisioning_algorithms(uint16_t algorithms)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_set_provisioning_algorithms_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_set_provisioning_algorithms_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_node_init_provisioning_records(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_init_provisioning_records_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                             ...
                                                             uint16_t adv_interval_max)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_set_unprov_beaconing_adv_interval_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_set_unprov_beaconing_adv_interval_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                          ...
                                                          uint16_t adv_interval_max)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_set_proxy_service_adv_interval_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_set_proxy_service_adv_interval_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                                 ...
                                                                 uint16_t adv_interval_max)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_set_provisioning_service_adv_interval_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_set_provisioning_service_adv_interval_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_node_get_local_model_metadata_page(uint8_t page)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_get_local_model_metadata_page_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_get_local_model_metadata_page_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_node_save_proxy_solicitation_rpl(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_save_proxy_solicitation_rpl_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                             ...
                                                             uint16_t *unsaved_entries)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_get_proxy_solicitation_rpl_status_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_node_set_oob_uri(size_t uri_len, const uint8_t* uri)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_set_oob_uri_t) + uri_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_set_oob_uri_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                       ...
                                       uint8_t *uri)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_get_oob_uri_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_node_set_proxy_service_uuid(uint16_t uuid)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_set_proxy_service_uuid_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_set_proxy_service_uuid_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                         ...
                                         uint8_t *match)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_test_identity_t) + data_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_test_identity_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_node_test_proxy_beacon(uint16_t address,
                                             size_t data_len,
                                             const uint8_t* data,
                                             uint8_t *match,
                                             uint8_t *private_proxy,
                                             uint16_t *netkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_test_proxy_beacon_t) + data_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_test_proxy_beacon_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    cmd->data.cmd_node_test_proxy_beacon.address = address;
    cmd->data.cmd_node_test_proxy_beacon.data.len = data_len;
    memcpy(cmd->data.cmd_node_test_proxy_beacon.data.data, data, data_len);
    sl_btmesh_host_handle_command();

    if (match) {
        *match = rsp->data.rsp_node_test_proxy_beacon.match;
    }
    if (private_proxy) {
        *private_proxy = rsp->data.rsp_node_test_proxy_beacon.private_proxy;
    }
    if (netkey_index) {
        *netkey_index = rsp->data.rsp_node_test_proxy_beacon.netkey_index;
    }

    return rsp->data.rsp_node_test_proxy_beacon.result;
}
                                                           ...
                                                           const uint8_t* scan_response_data)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_set_proxy_service_scan_response_t) + scan_response_data_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_set_proxy_service_scan_response_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_node_clear_proxy_service_scan_response(uint16_t netkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_clear_proxy_service_scan_response_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_clear_proxy_service_scan_response_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                                  ...
                                                                  const uint8_t* scan_response_data)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_set_provisioning_service_scan_response_t) + scan_response_data_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_set_provisioning_service_scan_response_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_node_clear_provisioning_service_scan_response(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_clear_provisioning_service_scan_response_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                       ...
                                       uint32_t *diff)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_node_compare_dcd_t) + page_data_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_node_class_id,
                                       sli_btmesh_node_compare_dcd_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_prov_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_prov_scan_unprov_beacons(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_scan_unprov_beacons_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                       ...
                                                       uint8_t attention_timer_sec)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_create_provisioning_session_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_create_provisioning_session_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_prov_set_provisioning_suspend_event(uint8_t status)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_set_provisioning_suspend_event_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_set_provisioning_suspend_event_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_prov_provision_adv_device(uuid_128 uuid)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_provision_adv_device_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_provision_adv_device_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                 ...
                                                 uint8_t connection)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_provision_gatt_device_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_provision_gatt_device_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                   ...
                                                   uint16_t server)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_provision_remote_device_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_provision_remote_device_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_prov_continue_provisioning(uuid_128 uuid)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_continue_provisioning_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_continue_provisioning_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_prov_abort_provisioning(uuid_128 uuid, uint8_t reason)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_abort_provisioning_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_abort_provisioning_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_prov_set_device_address(uuid_128 uuid, uint16_t address)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_set_device_address_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_set_device_address_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                          ...
                                          const uint8_t* key)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_create_network_t) + key_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_create_network_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                         ...
                                         uint8_t *application_key)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_create_appkey_t) + key_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_create_appkey_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  const uint8_t* pkey)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_send_oob_pkey_response_t) + pkey_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_send_oob_pkey_response_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  const uint8_t* data)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_send_oob_auth_response_t) + data_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_send_oob_auth_response_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint8_t max_size)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_set_oob_requirements_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_set_oob_requirements_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                             ...
                                             const uint8_t* appkey_indices)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_start_key_refresh_t) + appkey_indices_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_start_key_refresh_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                     ...
                                                     uint8_t *status)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_get_key_refresh_exclusion_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_get_key_refresh_exclusion_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                     ...
                                                     uuid_128 uuid)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_set_key_refresh_exclusion_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_set_key_refresh_exclusion_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_prov_set_key_refresh_failure(uint16_t key, uuid_128 uuid)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_set_key_refresh_failure_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_set_key_refresh_failure_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_prov_phase_timeout_get(uint32_t *phase_timeout_s)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_phase_timeout_get_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_prov_phase_timeout_set(uint32_t phase_timeout_s)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_phase_timeout_set_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_phase_timeout_set_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                         ...
                                         uint8_t *elements)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_get_ddb_entry_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_get_ddb_entry_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_prov_delete_ddb_entry(uuid_128 uuid)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_delete_ddb_entry_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_delete_ddb_entry_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                         ...
                                         uint8_t elements)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_add_ddb_entry_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_add_ddb_entry_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
SL_BGAPI_DEPRECATED sl_status_t sl_btmesh_prov_list_ddb_entries(uint16_t *count)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_list_ddb_entries_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_prov_initialize_network(uint16_t address, uint32_t ivi)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_initialize_network_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_initialize_network_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                            ...
                                                            uint8_t *status)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_get_key_refresh_appkey_exclusion_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_get_key_refresh_appkey_exclusion_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                            ...
                                                            uuid_128 uuid)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_set_key_refresh_appkey_exclusion_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_set_key_refresh_appkey_exclusion_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_prov_stop_scan_unprov_beacons(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_stop_scan_unprov_beacons_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                      ...
                                                      uint16_t netkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_update_device_netkey_index_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_update_device_netkey_index_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_prov_suspend_key_refresh(uint16_t netkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_suspend_key_refresh_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_suspend_key_refresh_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_prov_resume_key_refresh(uint16_t netkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_resume_key_refresh_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_resume_key_refresh_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                 ...
                                                 uint8_t *phase)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_get_key_refresh_phase_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_get_key_refresh_phase_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                        ...
                                                        const uint8_t* appkey_indices)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_start_key_refresh_from_phase_t) + appkey_indices_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_start_key_refresh_from_phase_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_prov_flush_key_refresh_state(uint16_t netkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_flush_key_refresh_state_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_flush_key_refresh_state_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_prov_get_provisioning_records_list(uuid_128 uuid)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_get_provisioning_records_list_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_get_provisioning_records_list_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                        ...
                                                        uint16_t record)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_prov_get_provisioning_record_data_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_get_provisioning_record_data_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_prov_init_provisioning_records(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_prov_class_id,
                                       sli_btmesh_prov_init_provisioning_records_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_proxy_connect(uint8_t connection, uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_proxy_connect_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_proxy_class_id,
                                       sli_btmesh_proxy_connect_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_proxy_disconnect(uint32_t handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_proxy_disconnect_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_proxy_class_id,
                                       sli_btmesh_proxy_disconnect_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                            ...
                                            uint8_t type)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_proxy_set_filter_type_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_proxy_class_id,
                                       sli_btmesh_proxy_set_filter_type_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                  ...
                                  uint16_t address)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_proxy_allow_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_proxy_class_id,
                                       sli_btmesh_proxy_allow_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                 ...
                                 uint16_t address)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_proxy_deny_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_proxy_class_id,
                                       sli_btmesh_proxy_deny_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_proxy_optimisation_toggle(uint8_t enable)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_proxy_optimisation_toggle_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_proxy_class_id,
                                       sli_btmesh_proxy_optimisation_toggle_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                              ...
                                              uint16_t dst)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_proxy_send_solicitation_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_proxy_class_id,
                                       sli_btmesh_proxy_send_solicitation_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_silabs_config_client_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_silabs_config_client_class_id,
                                       sli_btmesh_silabs_config_client_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                  ...
                                                  uint32_t tx_options_bitmap)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_silabs_config_client_set_tx_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_silabs_config_client_class_id,
                                       sli_btmesh_silabs_config_client_set_tx_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  uint16_t appkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_silabs_config_client_get_tx_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_silabs_config_client_class_id,
                                       sli_btmesh_silabs_config_client_get_tx_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                            ...
                                                            uint8_t enable)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_silabs_config_client_set_model_enable_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_silabs_config_client_class_id,
                                       sli_btmesh_silabs_config_client_set_model_enable_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                            ...
                                                            uint16_t model_id)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_silabs_config_client_get_model_enable_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_silabs_config_client_class_id,
                                       sli_btmesh_silabs_config_client_get_model_enable_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                           ...
                                                           uint16_t pdu_max_size)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_silabs_config_client_set_network_pdu_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_silabs_config_client_class_id,
                                       sli_btmesh_silabs_config_client_set_network_pdu_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                           ...
                                                           uint16_t appkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_silabs_config_client_get_network_pdu_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_silabs_config_client_class_id,
                                       sli_btmesh_silabs_config_client_get_network_pdu_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_silabs_config_client_deinit(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_silabs_config_client_class_id,
                                       sli_btmesh_silabs_config_client_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                        ...
                                        const uint8_t* payload)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_vendor_model_send_t) + payload_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_vendor_model_class_id,
                                       sli_btmesh_vendor_model_send_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                   ...
                                                   const uint8_t* payload)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_vendor_model_set_publication_t) + payload_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_vendor_model_class_id,
                                       sli_btmesh_vendor_model_set_publication_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                     ...
                                                     uint16_t model_id)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_vendor_model_clear_publication_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_vendor_model_class_id,
                                       sli_btmesh_vendor_model_clear_publication_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                           ...
                                           uint16_t model_id)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_vendor_model_publish_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_vendor_model_class_id,
                                       sli_btmesh_vendor_model_publish_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                        ...
                                        const uint8_t* opcodes)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_vendor_model_init_t) + opcodes_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_vendor_model_class_id,
                                       sli_btmesh_vendor_model_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                          ...
                                          uint16_t model_id)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_vendor_model_deinit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_vendor_model_class_id,
                                       sli_btmesh_vendor_model_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint16_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_vendor_model_send_tracked_t) + payload_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_vendor_model_class_id,
                                       sli_btmesh_vendor_model_send_tracked_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                           ...
                                                           uint16_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_vendor_model_set_publication_tracked_t) + payload_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_vendor_model_class_id,
                                       sli_btmesh_vendor_model_set_publication_tracked_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_vendor_model_set_option(uint8_t option, uint32_t value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_vendor_model_set_option_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_vendor_model_class_id,
                                       sli_btmesh_vendor_model_set_option_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_health_client_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_health_client_class_id,
                                       sli_btmesh_health_client_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_health_client_deinit(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_health_client_class_id,
                                       sli_btmesh_health_client_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                        ...
                                        uint16_t vendor_id)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_health_client_get_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_health_client_class_id,
                                       sli_btmesh_health_client_get_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                          ...
                                          uint8_t reliable)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_health_client_clear_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_health_client_class_id,
                                       sli_btmesh_health_client_clear_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                         ...
                                         uint8_t reliable)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_health_client_test_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_health_client_class_id,
                                       sli_btmesh_health_client_test_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               uint16_t appkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_health_client_get_period_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_health_client_class_id,
                                       sli_btmesh_health_client_get_period_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               uint8_t reliable)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_health_client_set_period_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_health_client_class_id,
                                       sli_btmesh_health_client_set_period_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  uint16_t appkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_health_client_get_attention_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_health_client_class_id,
                                       sli_btmesh_health_client_get_attention_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  uint8_t reliable)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_health_client_set_attention_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_health_client_class_id,
                                       sli_btmesh_health_client_set_attention_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_health_server_set_fault(uint16_t elem_index, uint8_t id)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_health_server_set_fault_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_health_server_class_id,
                                       sli_btmesh_health_server_set_fault_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint8_t id)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_health_server_clear_fault_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_health_server_class_id,
                                       sli_btmesh_health_server_clear_fault_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                       ...
                                                       uint16_t vendor_id)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_health_server_send_test_response_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_health_server_class_id,
                                       sli_btmesh_health_server_send_test_response_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                         ...
                                         uint8_t type)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_generic_client_get_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_client_class_id,
                                       sli_btmesh_generic_client_get_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                         ...
                                         const uint8_t* parameters)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_generic_client_set_t) + parameters_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_client_class_id,
                                       sli_btmesh_generic_client_set_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                             ...
                                             const uint8_t* parameters)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_generic_client_publish_t) + parameters_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_client_class_id,
                                       sli_btmesh_generic_client_publish_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                const uint8_t* parameters)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_generic_client_get_params_t) + parameters_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_client_class_id,
                                       sli_btmesh_generic_client_get_params_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_generic_client_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_client_class_id,
                                       sli_btmesh_generic_client_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_client_init_common(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_client_class_id,
                                       sli_btmesh_generic_client_init_common_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_client_init_on_off(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_client_class_id,
                                       sli_btmesh_generic_client_init_on_off_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_client_init_level(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_client_class_id,
                                       sli_btmesh_generic_client_init_level_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_client_init_default_transition_time(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_client_class_id,
                                       sli_btmesh_generic_client_init_default_transition_time_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_client_init_power_on_off(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_client_class_id,
                                       sli_btmesh_generic_client_init_power_on_off_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_client_init_power_level(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_client_class_id,
                                       sli_btmesh_generic_client_init_power_level_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_client_init_battery(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_client_class_id,
                                       sli_btmesh_generic_client_init_battery_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_client_init_location(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_client_class_id,
                                       sli_btmesh_generic_client_init_location_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_client_init_property(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_client_class_id,
                                       sli_btmesh_generic_client_init_property_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_client_init_lightness(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_client_class_id,
                                       sli_btmesh_generic_client_init_lightness_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_client_init_ctl(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_client_class_id,
                                       sli_btmesh_generic_client_init_ctl_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_client_init_hsl(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_client_class_id,
                                       sli_btmesh_generic_client_init_hsl_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                             ...
                                             const uint8_t* parameters)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_generic_server_respond_t) + parameters_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_server_class_id,
                                       sli_btmesh_generic_server_respond_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                            ...
                                            const uint8_t* parameters)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_generic_server_update_t) + parameters_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_server_class_id,
                                       sli_btmesh_generic_server_update_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                             ...
                                             uint8_t type)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_generic_server_publish_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_server_class_id,
                                       sli_btmesh_generic_server_publish_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_generic_server_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_server_class_id,
                                       sli_btmesh_generic_server_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_server_init_common(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_server_class_id,
                                       sli_btmesh_generic_server_init_common_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_server_init_on_off(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_server_class_id,
                                       sli_btmesh_generic_server_init_on_off_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_server_init_level(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_server_class_id,
                                       sli_btmesh_generic_server_init_level_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_server_init_default_transition_time(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_server_class_id,
                                       sli_btmesh_generic_server_init_default_transition_time_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_server_init_power_on_off(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_server_class_id,
                                       sli_btmesh_generic_server_init_power_on_off_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_server_init_power_level(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_server_class_id,
                                       sli_btmesh_generic_server_init_power_level_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_server_init_battery(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_server_class_id,
                                       sli_btmesh_generic_server_init_battery_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_server_init_location(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_server_class_id,
                                       sli_btmesh_generic_server_init_location_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_server_init_property(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_server_class_id,
                                       sli_btmesh_generic_server_init_property_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_server_init_lightness(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_server_class_id,
                                       sli_btmesh_generic_server_init_lightness_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_server_init_ctl(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_server_class_id,
                                       sli_btmesh_generic_server_init_ctl_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_generic_server_init_hsl(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_server_class_id,
                                       sli_btmesh_generic_server_init_hsl_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                      ...
                                                      uint8_t *parameters)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_generic_server_get_cached_state_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_generic_server_class_id,
                                       sli_btmesh_generic_server_get_cached_state_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_test_get_nettx(uint8_t *count, uint8_t *interval)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
...
sl_status_t sl_btmesh_test_set_nettx(uint8_t count, uint8_t interval)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_nettx_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_nettx_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                     ...
                                     uint8_t *interval)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_get_relay_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                     ...
                                     uint8_t interval)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_relay_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_relay_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_test_set_ivupdate_test_mode(uint8_t mode)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_ivupdate_test_mode_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_ivupdate_test_mode_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_test_get_ivupdate_test_mode(uint8_t *mode)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_get_ivupdate_test_mode_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_test_set_ivupdate_state(uint8_t state)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_ivupdate_state_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_ivupdate_state_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_test_send_beacons(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_send_beacons_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                ...
                                                uint16_t model_id)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_bind_local_model_app_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_bind_local_model_app_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  uint16_t model_id)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_unbind_local_model_app_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_unbind_local_model_app_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               uint16_t sub_address)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_add_local_model_sub_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_add_local_model_sub_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  uint16_t sub_address)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_remove_local_model_sub_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_remove_local_model_sub_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  const uint8_t* sub_address)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_add_local_model_sub_va_t) + sub_address_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_add_local_model_sub_va_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                     ...
                                                     const uint8_t* sub_address)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_remove_local_model_sub_va_t) + sub_address_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_remove_local_model_sub_va_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               uint8_t *addresses)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_get_local_model_sub_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_get_local_model_sub_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               uint8_t credentials)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_local_model_pub_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_local_model_pub_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  const uint8_t* pub_address)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_local_model_pub_va_t) + pub_address_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_local_model_pub_va_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               uint8_t *credentials)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_get_local_model_pub_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_get_local_model_pub_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                            ...
                                                            uint8_t period_log)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_local_heartbeat_subscription_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_local_heartbeat_subscription_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                            ...
                                                            uint8_t *hop_max)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_get_local_heartbeat_subscription_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                           ...
                                                           uint16_t *publication_netkey_index)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_get_local_heartbeat_publication_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                           ...
                                                           uint16_t publication_netkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_local_heartbeat_publication_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_local_heartbeat_publication_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                         ...
                                         uint16_t netkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_add_local_key_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_add_local_key_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                            ...
                                            uint16_t key_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_remove_local_key_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_remove_local_key_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                            ...
                                            uint16_t key_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_update_local_key_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_update_local_key_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_test_set_adv_bearer_state(uint8_t state)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_adv_bearer_state_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_adv_bearer_state_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               aes_key_128 *device_key)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_prov_get_device_key_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_prov_get_device_key_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                                        ...
                                                                        const uint8_t* app_keys)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_prov_prepare_key_refresh_t) + app_keys_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_prov_prepare_key_refresh_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               uint16_t dst_addr)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_cancel_segmented_tx_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_cancel_segmented_tx_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_test_set_iv_index(uint32_t iv_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_iv_index_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_iv_index_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                              ...
                                              uint32_t seqnum)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_element_seqnum_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_element_seqnum_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                            ...
                                            uint32_t value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_model_option_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_model_option_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                        ...
                                                        uint8_t *appkeys)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_get_local_model_app_bindings_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_get_local_model_app_bindings_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                            ...
                                                            uint32_t *seq_ivindex)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_get_replay_protection_list_entry_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_get_replay_protection_list_entry_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_test_clear_replay_protection_list_entry(uint16_t address)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_clear_replay_protection_list_entry_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_clear_replay_protection_list_entry_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_test_set_replay_protection_list_diagnostics(uint8_t enable)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_replay_protection_list_diagnostics_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_replay_protection_list_diagnostics_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                            ...
                                            uint32_t *value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_get_model_option_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_get_model_option_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_test_get_default_ttl(uint8_t *value)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_get_default_ttl_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_test_set_default_ttl(uint8_t set_value, uint8_t *value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_default_ttl_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_default_ttl_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_test_get_gatt_proxy(uint8_t *value)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_get_gatt_proxy_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_test_set_gatt_proxy(uint8_t set_value, uint8_t *value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_gatt_proxy_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_gatt_proxy_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                        ...
                                        uint8_t *value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_get_identity_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_get_identity_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                        ...
                                        uint8_t *value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_identity_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_identity_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_test_get_friend(uint8_t *value)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_get_friend_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_test_set_friend(uint8_t set_value, uint8_t *value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_friend_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_friend_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_test_get_beacon(uint8_t *value)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_get_beacon_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_test_set_beacon(uint8_t set_value, uint8_t *value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_beacon_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_beacon_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint8_t *value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_get_private_identity_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_get_private_identity_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint8_t *value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_private_identity_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_private_identity_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                              ...
                                                              uint16_t pbadv_variation_ms)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_adv_provisioning_bearer_timing_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_adv_provisioning_bearer_timing_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                   ...
                                                   uint8_t *phase)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_update_keyrefresh_phase_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_update_keyrefresh_phase_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_test_send_private_beacons(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_send_private_beacons_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                          ...
                                          uint8_t adv_channel_map)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_adv_params_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_adv_params_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                           ...
                                           uint16_t scan_window)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_set_scan_params_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_set_scan_params_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_test_adv_use_random_address(uint8_t address_type)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_test_adv_use_random_address_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_test_class_id,
                                       sli_btmesh_test_adv_use_random_address_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_lpn_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lpn_class_id,
                                       sli_btmesh_lpn_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_lpn_deinit(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lpn_class_id,
                                       sli_btmesh_lpn_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_lpn_establish_friendship(uint16_t netkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lpn_establish_friendship_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lpn_class_id,
                                       sli_btmesh_lpn_establish_friendship_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_lpn_poll(uint16_t netkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lpn_poll_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lpn_class_id,
                                       sli_btmesh_lpn_poll_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_lpn_terminate_friendship(uint16_t netkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lpn_terminate_friendship_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lpn_class_id,
                                       sli_btmesh_lpn_terminate_friendship_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_lpn_config(uint8_t setting_id, uint32_t value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lpn_config_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lpn_class_id,
                                       sli_btmesh_lpn_config_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_friend_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_friend_class_id,
                                       sli_btmesh_friend_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_friend_deinit(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_friend_class_id,
                                       sli_btmesh_friend_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_config_client_cancel_request(uint32_t handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_cancel_request_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_cancel_request_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                       ...
                                                       uint8_t *friend_acked)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_get_request_status_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_get_request_status_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                        ...
                                                        uint32_t *lpn_timeout_ms)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_get_default_timeout_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                        ...
                                                        uint32_t lpn_timeout_ms)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_set_default_timeout_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_set_default_timeout_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_add_netkey_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_add_netkey_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_remove_netkey_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_remove_netkey_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                 ...
                                                 uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_list_netkeys_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_list_netkeys_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_add_appkey_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_add_appkey_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_remove_appkey_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_remove_appkey_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                 ...
                                                 uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_list_appkeys_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_list_appkeys_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_bind_model_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_bind_model_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                 ...
                                                 uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_unbind_model_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_unbind_model_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_list_bindings_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_list_bindings_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_get_model_pub_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_get_model_pub_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_set_model_pub_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_set_model_pub_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                     ...
                                                     uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_set_model_pub_va_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_set_model_pub_va_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_add_model_sub_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_add_model_sub_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                     ...
                                                     uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_add_model_sub_va_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_add_model_sub_va_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                     ...
                                                     uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_remove_model_sub_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_remove_model_sub_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                        ...
                                                        uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_remove_model_sub_va_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_remove_model_sub_va_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_set_model_sub_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_set_model_sub_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                     ...
                                                     uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_set_model_sub_va_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_set_model_sub_va_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                    ...
                                                    uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_clear_model_sub_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_clear_model_sub_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                              ...
                                              uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_list_subs_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_list_subs_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                      ...
                                                      uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_get_heartbeat_pub_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_get_heartbeat_pub_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                      ...
                                                      uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_set_heartbeat_pub_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_set_heartbeat_pub_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                      ...
                                                      uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_get_heartbeat_sub_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_get_heartbeat_sub_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                      ...
                                                      uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_set_heartbeat_sub_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_set_heartbeat_sub_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_get_beacon_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_get_beacon_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_set_beacon_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_set_beacon_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                    ...
                                                    uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_get_default_ttl_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_get_default_ttl_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                    ...
                                                    uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_set_default_ttl_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_set_default_ttl_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                   ...
                                                   uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_get_gatt_proxy_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_get_gatt_proxy_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                   ...
                                                   uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_set_gatt_proxy_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_set_gatt_proxy_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                              ...
                                              uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_get_relay_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_get_relay_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                              ...
                                              uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_set_relay_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_set_relay_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                         ...
                                                         uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_get_network_transmit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_get_network_transmit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                         ...
                                                         uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_set_network_transmit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_set_network_transmit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                 ...
                                                 uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_get_identity_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_get_identity_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                 ...
                                                 uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_set_identity_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_set_identity_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_get_friend_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_get_friend_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_set_friend_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_set_friend_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                          ...
                                                          uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_get_key_refresh_phase_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_get_key_refresh_phase_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                        ...
                                                        uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_get_lpn_polltimeout_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_get_lpn_polltimeout_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                            ...
                                            uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_get_dcd_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_get_dcd_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_reset_node_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_reset_node_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                                 ...
                                                                 uint16_t timeout_ms)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_set_request_timeout_for_node_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_set_request_timeout_for_node_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                        ...
                                                        const uint8_t* app_keys)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_config_client_prepare_key_refresh_t) + app_keys_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_config_client_class_id,
                                       sli_btmesh_config_client_prepare_key_refresh_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                      ...
                                      uint16_t max_chunks_per_block)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_client_init_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_client_class_id,
                                       sli_btmesh_mbt_client_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_mbt_client_deinit(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_client_deinit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_client_class_id,
                                       sli_btmesh_mbt_client_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    cmd->data.cmd_mbt_client_deinit.elem_index = elem_index;
    sl_btmesh_host_handle_command();

    return rsp->data.rsp_mbt_client_deinit.result;
}
                                       ...
                                       const uint8_t* servers)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_client_setup_t) + servers_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_client_class_id,
                                       sli_btmesh_mbt_client_setup_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_mbt_client_query_information(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_client_query_information_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_client_class_id,
                                       sli_btmesh_mbt_client_query_information_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                   ...
                                                   uint16_t *rx_chunks)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_client_get_server_status_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_client_class_id,
                                       sli_btmesh_mbt_client_get_server_status_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                            ...
                                            uint16_t server_address)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_client_add_server_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_client_class_id,
                                       sli_btmesh_mbt_client_add_server_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                    ...
                                                    uint8_t throttle_concurrent)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_client_configure_throttle_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_client_class_id,
                                       sli_btmesh_mbt_client_configure_throttle_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint8_t transfer_mode)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_client_start_transfer_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_client_class_id,
                                       sli_btmesh_mbt_client_start_transfer_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                             ...
                                             uint32_t *block_size)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_client_start_block_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_client_class_id,
                                       sli_btmesh_mbt_client_start_block_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                        ...
                                                        const uint8_t* data)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_client_send_chunk_request_rsp_t) + data_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_client_class_id,
                                       sli_btmesh_mbt_client_send_chunk_request_rsp_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_mbt_client_query_block_status(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_client_query_block_status_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_client_class_id,
                                       sli_btmesh_mbt_client_query_block_status_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                            ...
                                            uint16_t *total_chunks)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_client_get_status_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_client_class_id,
                                       sli_btmesh_mbt_client_get_status_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                     ...
                                                     uint8_t ttl)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_client_get_transfer_status_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_client_class_id,
                                       sli_btmesh_mbt_client_get_transfer_status_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_mbt_client_cancel_transfer(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_client_cancel_transfer_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_client_class_id,
                                       sli_btmesh_mbt_client_cancel_transfer_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_mbt_client_abort(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_client_abort_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_client_class_id,
                                       sli_btmesh_mbt_client_abort_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                      ...
                                      uint16_t pull_mode_retry_count)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_server_init_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_server_class_id,
                                       sli_btmesh_mbt_server_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_mbt_server_deinit(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_server_deinit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_server_class_id,
                                       sli_btmesh_mbt_server_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    cmd->data.cmd_mbt_server_deinit.elem_index = elem_index;
    sl_btmesh_host_handle_command();

    return rsp->data.rsp_mbt_server_deinit.result;
}
                                       ...
                                       uint8_t ttl)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_server_start_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_server_class_id,
                                       sli_btmesh_mbt_server_start_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                     ...
                                                     uint8_t *blocks_missing_mask)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_server_get_transfer_status_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_server_class_id,
                                       sli_btmesh_mbt_server_get_transfer_status_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_mbt_server_transfer_complete(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_server_transfer_complete_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_server_class_id,
                                       sli_btmesh_mbt_server_transfer_complete_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_mbt_server_abort(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_server_abort_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_server_class_id,
                                       sli_btmesh_mbt_server_abort_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                          ...
                                                          uint16_t pull_mode_retry_count)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_server_set_pull_mode_parameters_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_server_class_id,
                                       sli_btmesh_mbt_server_set_pull_mode_parameters_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                    ...
                                                    uint8_t status)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_server_transfer_start_rsp_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_server_class_id,
                                       sli_btmesh_mbt_server_transfer_start_rsp_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_mbt_server_enable_block_start_req(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_server_enable_block_start_req_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_server_class_id,
                                       sli_btmesh_mbt_server_enable_block_start_req_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                 ...
                                                 uint8_t status)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_mbt_server_block_start_rsp_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_mbt_server_class_id,
                                       sli_btmesh_mbt_server_block_start_rsp_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                         ...
                                         const uint8_t* descriptors)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sensor_server_init_t) + descriptors_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_server_class_id,
                                       sli_btmesh_sensor_server_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_sensor_server_deinit(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sensor_server_deinit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_server_class_id,
                                       sli_btmesh_sensor_server_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                           ...
                                                           const uint8_t* descriptors)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sensor_server_send_descriptor_status_t) + descriptors_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_server_class_id,
                                       sli_btmesh_sensor_server_send_descriptor_status_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                const uint8_t* sensor_data)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sensor_server_send_status_t) + sensor_data_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_server_class_id,
                                       sli_btmesh_sensor_server_send_status_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                       ...
                                                       const uint8_t* sensor_data)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sensor_server_send_column_status_t) + sensor_data_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_server_class_id,
                                       sli_btmesh_sensor_server_send_column_status_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                       ...
                                                       const uint8_t* sensor_data)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sensor_server_send_series_status_t) + sensor_data_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_server_class_id,
                                       sli_btmesh_sensor_server_send_series_status_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                              ...
                                                              const uint8_t* params)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sensor_setup_server_send_cadence_status_t) + params_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_setup_server_class_id,
                                       sli_btmesh_sensor_setup_server_send_cadence_status_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                               ...
                                                               const uint8_t* setting_ids)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sensor_setup_server_send_settings_status_t) + setting_ids_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_setup_server_class_id,
                                       sli_btmesh_sensor_setup_server_send_settings_status_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                              ...
                                                              const uint8_t* raw_value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sensor_setup_server_send_setting_status_t) + raw_value_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_setup_server_class_id,
                                       sli_btmesh_sensor_setup_server_send_setting_status_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_sensor_client_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_client_class_id,
                                       sli_btmesh_sensor_client_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_sensor_client_deinit(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_client_class_id,
                                       sli_btmesh_sensor_client_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                   ...
                                                   uint16_t property_id)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sensor_client_get_descriptor_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_client_class_id,
                                       sli_btmesh_sensor_client_get_descriptor_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                        ...
                                        uint16_t property_id)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sensor_client_get_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_client_class_id,
                                       sli_btmesh_sensor_client_get_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               const uint8_t* column_id)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sensor_client_get_column_t) + column_id_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_client_class_id,
                                       sli_btmesh_sensor_client_get_column_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               const uint8_t* column_ids)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sensor_client_get_series_t) + column_ids_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_client_class_id,
                                       sli_btmesh_sensor_client_get_series_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint16_t property_id)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sensor_client_get_cadence_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_client_class_id,
                                       sli_btmesh_sensor_client_get_cadence_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                const uint8_t* params)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sensor_client_set_cadence_t) + params_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_client_class_id,
                                       sli_btmesh_sensor_client_set_cadence_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                 ...
                                                 uint16_t property_id)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sensor_client_get_settings_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_client_class_id,
                                       sli_btmesh_sensor_client_get_settings_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint16_t setting_id)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sensor_client_get_setting_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_client_class_id,
                                       sli_btmesh_sensor_client_get_setting_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                const uint8_t* raw_value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sensor_client_set_setting_t) + raw_value_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sensor_client_class_id,
                                       sli_btmesh_sensor_client_set_setting_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_fw_update_client_init(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_update_client_init_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_update_client_class_id,
                                       sli_btmesh_fw_update_client_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_fw_update_client_deinit(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_update_client_deinit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_update_client_class_id,
                                       sli_btmesh_fw_update_client_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint8_t max_entries)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_update_client_get_info_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_update_client_class_id,
                                       sli_btmesh_fw_update_client_get_info_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  uint8_t ttl)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_update_client_get_update_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_update_client_class_id,
                                       sli_btmesh_fw_update_client_get_update_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                    ...
                                                    const uint8_t* metadata)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_update_client_start_update_t) + metadata_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_update_client_class_id,
                                       sli_btmesh_fw_update_client_start_update_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                     ...
                                                     uint8_t ttl)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_update_client_cancel_update_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_update_client_class_id,
                                       sli_btmesh_fw_update_client_cancel_update_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                    ...
                                                    uint8_t ttl)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_update_client_apply_update_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_update_client_class_id,
                                       sli_btmesh_fw_update_client_apply_update_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                      ...
                                                      const uint8_t* metadata)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_update_client_check_metadata_t) + metadata_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_update_client_class_id,
                                       sli_btmesh_fw_update_client_check_metadata_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_lc_client_init(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_client_init_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_client_class_id,
                                       sli_btmesh_lc_client_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                         ...
                                         uint16_t appkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_client_get_mode_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_client_class_id,
                                       sli_btmesh_lc_client_get_mode_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                         ...
                                         uint8_t mode)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_client_set_mode_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_client_class_id,
                                       sli_btmesh_lc_client_set_mode_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                       ...
                                       uint16_t appkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_client_get_om_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_client_class_id,
                                       sli_btmesh_lc_client_get_om_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                       ...
                                       uint8_t mode)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_client_set_om_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_client_class_id,
                                       sli_btmesh_lc_client_set_om_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint16_t appkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_client_get_light_onoff_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_client_class_id,
                                       sli_btmesh_lc_client_get_light_onoff_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint16_t message_delay_ms)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_client_set_light_onoff_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_client_class_id,
                                       sli_btmesh_lc_client_set_light_onoff_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                             ...
                                             uint16_t property_id)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_client_get_property_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_client_class_id,
                                       sli_btmesh_lc_client_get_property_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                             ...
                                             const uint8_t* params)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_client_set_property_t) + params_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_client_class_id,
                                       sli_btmesh_lc_client_set_property_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_lc_server_init(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_server_init_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_server_class_id,
                                       sli_btmesh_lc_server_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_lc_server_deinit(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_server_deinit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_server_class_id,
                                       sli_btmesh_lc_server_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_lc_server_update_mode(uint16_t elem_index, uint8_t mode)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_server_update_mode_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_server_class_id,
                                       sli_btmesh_lc_server_update_mode_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_lc_server_update_om(uint16_t elem_index, uint8_t om)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_server_update_om_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_server_class_id,
                                       sli_btmesh_lc_server_update_om_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                   ...
                                                   uint32_t transition_time_ms)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_server_update_light_onoff_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_server_class_id,
                                       sli_btmesh_lc_server_update_light_onoff_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_lc_server_init_all_properties(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_server_init_all_properties_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_server_class_id,
                                       sli_btmesh_lc_server_init_all_properties_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                 ...
                                                 uint8_t value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_server_set_publish_mask_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_server_class_id,
                                       sli_btmesh_lc_server_set_publish_mask_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                       ...
                                                       uint8_t value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_server_set_regulator_interval_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_server_class_id,
                                       sli_btmesh_lc_server_set_regulator_interval_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               uint8_t value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_server_set_event_mask_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_server_class_id,
                                       sli_btmesh_lc_server_set_event_mask_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                             ...
                                             uint32_t *transition_time)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_server_get_lc_state_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_server_class_id,
                                       sli_btmesh_lc_server_get_lc_state_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                      ...
                                                      const uint8_t* params)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lc_setup_server_update_property_t) + params_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lc_setup_server_class_id,
                                       sli_btmesh_lc_setup_server_update_property_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_scene_client_init(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scene_client_init_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scene_client_class_id,
                                       sli_btmesh_scene_client_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                       ...
                                       uint16_t appkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scene_client_get_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scene_client_class_id,
                                       sli_btmesh_scene_client_get_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint16_t appkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scene_client_get_register_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scene_client_class_id,
                                       sli_btmesh_scene_client_get_register_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                          ...
                                          uint16_t delay_ms)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scene_client_recall_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scene_client_class_id,
                                       sli_btmesh_scene_client_recall_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                         ...
                                         uint8_t flags)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scene_client_store_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scene_client_class_id,
                                       sli_btmesh_scene_client_store_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                          ...
                                          uint8_t flags)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scene_client_delete_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scene_client_class_id,
                                       sli_btmesh_scene_client_delete_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_scene_client_deinit(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scene_client_deinit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scene_client_class_id,
                                       sli_btmesh_scene_client_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_scene_server_init(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scene_server_init_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scene_server_class_id,
                                       sli_btmesh_scene_server_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_scene_server_deinit(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scene_server_deinit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scene_server_class_id,
                                       sli_btmesh_scene_server_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_scene_server_reset_register(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scene_server_reset_register_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scene_server_class_id,
                                       sli_btmesh_scene_server_reset_register_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_scene_server_enable_compact_recall_events(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scene_server_class_id,
                                       sli_btmesh_scene_server_enable_compact_recall_events_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_scene_setup_server_init(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scene_setup_server_init_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scene_setup_server_class_id,
                                       sli_btmesh_scene_setup_server_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_scene_setup_server_deinit(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scene_setup_server_deinit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scene_setup_server_class_id,
                                       sli_btmesh_scene_setup_server_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_scheduler_client_init(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scheduler_client_init_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scheduler_client_class_id,
                                       sli_btmesh_scheduler_client_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_scheduler_client_deinit(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scheduler_client_deinit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scheduler_client_class_id,
                                       sli_btmesh_scheduler_client_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                           ...
                                           uint16_t appkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scheduler_client_get_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scheduler_client_class_id,
                                       sli_btmesh_scheduler_client_get_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  uint8_t index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scheduler_client_get_action_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scheduler_client_class_id,
                                       sli_btmesh_scheduler_client_get_action_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  uint16_t scene_number)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scheduler_client_set_action_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scheduler_client_class_id,
                                       sli_btmesh_scheduler_client_set_action_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_scheduler_server_init(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scheduler_server_init_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scheduler_server_class_id,
                                       sli_btmesh_scheduler_server_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_scheduler_server_deinit(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scheduler_server_deinit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scheduler_server_class_id,
                                       sli_btmesh_scheduler_server_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                           ...
                                           uint16_t *status)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scheduler_server_get_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scheduler_server_class_id,
                                       sli_btmesh_scheduler_server_get_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  uint16_t *scene_number)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scheduler_server_get_action_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scheduler_server_class_id,
                                       sli_btmesh_scheduler_server_get_action_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  uint16_t scene_number)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_scheduler_server_set_action_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_scheduler_server_class_id,
                                       sli_btmesh_scheduler_server_set_action_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                            ...
                                            uint8_t max_metadata_len)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_update_server_init_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_update_server_class_id,
                                       sli_btmesh_fw_update_server_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_fw_update_server_deinit(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_update_server_deinit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_update_server_class_id,
                                       sli_btmesh_fw_update_server_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                             ...
                                                             uint8_t fw_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_update_server_check_fw_metadata_rsp_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_update_server_class_id,
                                       sli_btmesh_fw_update_server_check_fw_metadata_rsp_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                        ...
                                                        uint8_t additional_information)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_update_server_update_start_rsp_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_update_server_class_id,
                                       sli_btmesh_fw_update_server_update_start_rsp_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                     ...
                                                     uint8_t accept)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_update_server_verify_fw_rsp_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_update_server_class_id,
                                       sli_btmesh_fw_update_server_verify_fw_rsp_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                                   ...
                                                                   uint8_t additional_information)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_update_server_distributor_self_update_rsp_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_update_server_class_id,
                                       sli_btmesh_fw_update_server_distributor_self_update_rsp_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_time_server_init(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_server_init_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_server_class_id,
                                       sli_btmesh_time_server_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_time_server_deinit(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_server_deinit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_server_class_id,
                                       sli_btmesh_time_server_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                           ...
                                           int32_t *tai_utc_delta)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_server_get_time_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_server_class_id,
                                       sli_btmesh_time_server_get_time_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                           ...
                                           int32_t tai_utc_delta)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_server_set_time_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_server_class_id,
                                       sli_btmesh_time_server_set_time_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                           ...
                                                           uint64_t *tai_of_zone_change)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_server_get_time_zone_offset_new_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_server_class_id,
                                       sli_btmesh_time_server_get_time_zone_offset_new_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                           ...
                                                           uint64_t tai_of_zone_change)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_server_set_time_zone_offset_new_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_server_class_id,
                                       sli_btmesh_time_server_set_time_zone_offset_new_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                        ...
                                                        uint64_t *tai_of_delta_change)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_server_get_tai_utc_delta_new_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_server_class_id,
                                       sli_btmesh_time_server_get_tai_utc_delta_new_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                        ...
                                                        uint64_t tai_of_delta_change)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_server_set_tai_utc_delta_new_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_server_class_id,
                                       sli_btmesh_time_server_set_tai_utc_delta_new_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint8_t *time_role)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_server_get_time_role_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_server_class_id,
                                       sli_btmesh_time_server_get_time_role_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint8_t time_role)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_server_set_time_role_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_server_class_id,
                                       sli_btmesh_time_server_set_time_role_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               uint8_t *day_of_week)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_server_get_datetime_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_server_class_id,
                                       sli_btmesh_time_server_get_datetime_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_time_server_publish(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_server_publish_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_server_class_id,
                                       sli_btmesh_time_server_publish_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                         ...
                                         uint16_t appkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_server_status_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_server_class_id,
                                       sli_btmesh_time_server_status_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_time_client_init(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_client_init_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_client_class_id,
                                       sli_btmesh_time_client_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_time_client_deinit(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_client_deinit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_client_class_id,
                                       sli_btmesh_time_client_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                           ...
                                           uint16_t appkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_client_get_time_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_client_class_id,
                                       sli_btmesh_time_client_get_time_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                           ...
                                           int16_t time_zone_offset)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_client_set_time_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_client_class_id,
                                       sli_btmesh_time_client_set_time_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint16_t appkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_client_get_time_zone_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_client_class_id,
                                       sli_btmesh_time_client_get_time_zone_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint64_t tai_of_zone_change)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_client_set_time_zone_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_client_class_id,
                                       sli_btmesh_time_client_set_time_zone_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                    ...
                                                    uint16_t appkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_client_get_tai_utc_delta_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_client_class_id,
                                       sli_btmesh_time_client_get_tai_utc_delta_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                    ...
                                                    uint64_t tai_of_delta_change)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_client_set_tai_utc_delta_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_client_class_id,
                                       sli_btmesh_time_client_set_tai_utc_delta_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint16_t appkey_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_client_get_time_role_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_client_class_id,
                                       sli_btmesh_time_client_get_time_role_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint8_t time_role)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_time_client_set_time_role_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_time_client_class_id,
                                       sli_btmesh_time_client_set_time_role_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                          ...
                                          const uint8_t* oob_supported_uri_scheme_names)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_server_init_t) + oob_supported_uri_scheme_names_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_server_class_id,
                                       sli_btmesh_fw_dist_server_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_fw_dist_server_deinit(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_server_deinit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_server_class_id,
                                       sli_btmesh_fw_dist_server_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                      ...
                                                      uint8_t status)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_server_upload_start_rsp_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_server_class_id,
                                       sli_btmesh_fw_dist_server_upload_start_rsp_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_fw_dist_server_execute_distribution_step(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_server_execute_distribution_step_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_server_class_id,
                                       sli_btmesh_fw_dist_server_execute_distribution_step_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                          ...
                                                          const uint8_t* fwid)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_server_upload_oob_start_rsp_t) + fwid_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_server_class_id,
                                       sli_btmesh_fw_dist_server_upload_oob_start_rsp_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                             ...
                                                             const uint8_t* metadata)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_server_set_upload_oob_metadata_t) + metadata_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_server_class_id,
                                       sli_btmesh_fw_dist_server_set_upload_oob_metadata_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                               ...
                                                               uint32_t size)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_server_set_upload_oob_image_size_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_server_class_id,
                                       sli_btmesh_fw_dist_server_set_upload_oob_image_size_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                             ...
                                                             uint16_t *fw_list_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_server_set_upload_oob_progress_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_server_class_id,
                                       sli_btmesh_fw_dist_server_set_upload_oob_progress_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                              ...
                                                              uint8_t *fw_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_server_get_node_status_by_index_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_server_class_id,
                                       sli_btmesh_fw_dist_server_get_node_status_by_index_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                                ...
                                                                uint8_t *fw_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_server_get_node_status_by_address_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_server_class_id,
                                       sli_btmesh_fw_dist_server_get_node_status_by_address_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                const uint8_t* fwid)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_server_delete_rsp_t) + fwid_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_server_class_id,
                                       sli_btmesh_fw_dist_server_delete_rsp_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                    ...
                                                    uint16_t status)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_server_dist_start_rsp_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_server_class_id,
                                       sli_btmesh_fw_dist_server_dist_start_rsp_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                             ...
                                                             uint16_t multicast_threshold)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_server_set_multicast_threshold_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_server_class_id,
                                       sli_btmesh_fw_dist_server_set_multicast_threshold_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                    ...
                                                    uint16_t status)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_server_delete_all_rsp_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_server_class_id,
                                       sli_btmesh_fw_dist_server_delete_all_rsp_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint16_t status)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_server_resume_rsp_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_server_class_id,
                                       sli_btmesh_fw_dist_server_resume_rsp_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                        ...
                                                        uint8_t throttle_concurrent)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_server_configure_throttle_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_server_class_id,
                                       sli_btmesh_fw_dist_server_configure_throttle_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_fw_dist_client_init(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_init_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_fw_dist_client_deinit(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_deinit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                           ...
                                           uint8_t ttl)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_setup_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_setup_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  const uint8_t* fwid)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_setup_upload_t) + fwid_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_setup_upload_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                         ...
                                                         const uint8_t* metadata)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_set_upload_metadata_t) + metadata_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_set_upload_metadata_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                   ...
                                                   uint16_t max_entries)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_get_receivers_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_get_receivers_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_fw_dist_client_get(uint16_t elem_index, uint16_t dst)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_get_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_get_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                        ...
                                                        uuid_128 virtual_address)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_start_distribution_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_start_distribution_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                         ...
                                                         uint16_t dst)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_cancel_distribution_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_cancel_distribution_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                        ...
                                                        uint16_t dst)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_apply_distribution_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_apply_distribution_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                          ...
                                                          uint16_t dst)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_suspend_distribution_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_suspend_distribution_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                   ...
                                                   const uint8_t* nodes)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_add_receivers_t) + nodes_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_add_receivers_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                          ...
                                                          uint16_t dst)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_delete_all_receivers_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_delete_all_receivers_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                      ...
                                                      uint16_t dst)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_get_capabilities_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_get_capabilities_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                ...
                                                uint16_t dst)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_get_upload_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_get_upload_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_fw_dist_client_start_upload(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_start_upload_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_start_upload_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                   ...
                                                   uint16_t dst)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_cancel_upload_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_cancel_upload_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                            ...
                                            const uint8_t* fwid)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_get_fw_t) + fwid_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_get_fw_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                     ...
                                                     uint16_t index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_get_fw_by_index_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_get_fw_by_index_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                               ...
                                               const uint8_t* fwid)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_delete_fw_t) + fwid_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_delete_fw_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                   ...
                                                   uint16_t dst)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_delete_all_fw_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_delete_all_fw_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                        ...
                                                        const uint8_t* fwid)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_prepare_oob_upload_t) + fwid_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_prepare_oob_upload_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                      ...
                                                      const uint8_t* uri)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_start_oob_upload_t) + uri_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_start_oob_upload_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_fw_dist_client_suspend_upload(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_suspend_upload_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_suspend_upload_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_fw_dist_client_resume_upload(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_dist_client_resume_upload_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_dist_client_class_id,
                                       sli_btmesh_fw_dist_client_resume_upload_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_remote_provisioning_client_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_remote_provisioning_client_class_id,
                                       sli_btmesh_remote_provisioning_client_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                                       ...
                                                                       uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_remote_provisioning_client_get_scan_capabilities_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_remote_provisioning_client_class_id,
                                       sli_btmesh_remote_provisioning_client_get_scan_capabilities_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                            ...
                                                            uuid_128 uuid)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_remote_provisioning_client_start_scan_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_remote_provisioning_client_class_id,
                                       sli_btmesh_remote_provisioning_client_start_scan_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                                 ...
                                                                 uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_remote_provisioning_client_get_scan_status_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_remote_provisioning_client_class_id,
                                       sli_btmesh_remote_provisioning_client_get_scan_status_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                           ...
                                                           uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_remote_provisioning_client_stop_scan_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_remote_provisioning_client_class_id,
                                       sli_btmesh_remote_provisioning_client_stop_scan_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                                     ...
                                                                     const uint8_t* ad_types)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_remote_provisioning_client_start_extended_scan_t) + ad_types_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_remote_provisioning_client_class_id,
                                       sli_btmesh_remote_provisioning_client_start_extended_scan_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                           ...
                                                           uuid_128 uuid)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_remote_provisioning_client_open_link_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_remote_provisioning_client_class_id,
                                       sli_btmesh_remote_provisioning_client_open_link_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                                 ...
                                                                 uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_remote_provisioning_client_get_link_status_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_remote_provisioning_client_class_id,
                                       sli_btmesh_remote_provisioning_client_get_link_status_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                            ...
                                                            uint8_t reason)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_remote_provisioning_client_close_link_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_remote_provisioning_client_class_id,
                                       sli_btmesh_remote_provisioning_client_close_link_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_remote_provisioning_server_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_remote_provisioning_server_class_id,
                                       sli_btmesh_remote_provisioning_server_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_remote_provisioning_server_open_link(uint8_t connection)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_remote_provisioning_server_open_link_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_remote_provisioning_server_class_id,
                                       sli_btmesh_remote_provisioning_server_open_link_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_remote_provisioning_server_set_default_bearer(uint8_t bearer)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_remote_provisioning_server_set_default_bearer_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_remote_provisioning_server_class_id,
                                       sli_btmesh_remote_provisioning_server_set_default_bearer_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                 ...
                                                 uint16_t max_node_list_size)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_standalone_updater_init_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_standalone_updater_class_id,
                                       sli_btmesh_fw_standalone_updater_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_fw_standalone_updater_deinit(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_standalone_updater_deinit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_standalone_updater_class_id,
                                       sli_btmesh_fw_standalone_updater_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  const uint8_t* fwid)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_standalone_updater_setup_t) + fwid_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_standalone_updater_class_id,
                                       sli_btmesh_fw_standalone_updater_setup_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                         ...
                                                         const uint8_t* metadata)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_standalone_updater_set_metadata_t) + metadata_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_standalone_updater_class_id,
                                       sli_btmesh_fw_standalone_updater_set_metadata_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                                    ...
                                                                    uint16_t multicast_threshold)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_standalone_updater_set_multicast_threshold_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_standalone_updater_class_id,
                                       sli_btmesh_fw_standalone_updater_set_multicast_threshold_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                         ...
                                                         uint8_t fw_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_standalone_updater_add_receiver_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_standalone_updater_class_id,
                                       sli_btmesh_fw_standalone_updater_add_receiver_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_fw_standalone_updater_delete_all_receivers(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_standalone_updater_delete_all_receivers_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_standalone_updater_class_id,
                                       sli_btmesh_fw_standalone_updater_delete_all_receivers_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  uuid_128 virtual_address)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_standalone_updater_start_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_standalone_updater_class_id,
                                       sli_btmesh_fw_standalone_updater_start_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_fw_standalone_updater_execute_distribution_step(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_standalone_updater_execute_distribution_step_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_standalone_updater_class_id,
                                       sli_btmesh_fw_standalone_updater_execute_distribution_step_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_fw_standalone_updater_apply(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_standalone_updater_apply_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_standalone_updater_class_id,
                                       sli_btmesh_fw_standalone_updater_apply_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                      ...
                                                      uint16_t *num_active_nodes)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_standalone_updater_get_state_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_standalone_updater_class_id,
                                       sli_btmesh_fw_standalone_updater_get_state_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                                     ...
                                                                     uint8_t *fw_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_standalone_updater_get_node_status_by_index_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_standalone_updater_class_id,
                                       sli_btmesh_fw_standalone_updater_get_node_status_by_index_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                                       ...
                                                                       uint8_t *fw_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_standalone_updater_get_node_status_by_address_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_standalone_updater_class_id,
                                       sli_btmesh_fw_standalone_updater_get_node_status_by_address_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_fw_standalone_updater_cancel(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_standalone_updater_cancel_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_standalone_updater_class_id,
                                       sli_btmesh_fw_standalone_updater_cancel_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                               ...
                                                               uint8_t throttle_concurrent)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_fw_standalone_updater_configure_throttle_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_fw_standalone_updater_class_id,
                                       sli_btmesh_fw_standalone_updater_configure_throttle_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_migration_migrate_keys(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_migration_class_id,
...
sl_status_t sl_btmesh_migration_migrate_ddb(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_migration_class_id,
                                       sli_btmesh_migration_migrate_ddb_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_ncp_fw_list_init(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_ncp_fw_list_init_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_ncp_fw_list_class_id,
                                       sli_btmesh_ncp_fw_list_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_ncp_fw_list_deinit(uint16_t elem_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_ncp_fw_list_deinit_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_ncp_fw_list_class_id,
                                       sli_btmesh_ncp_fw_list_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                       ...
                                                       uint8_t *fwid)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_ncp_fw_list_get_fw_info_by_index_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_ncp_fw_list_class_id,
                                       sli_btmesh_ncp_fw_list_get_fw_info_by_index_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                           ...
                                                           uint8_t *metadata)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_ncp_fw_list_get_fw_metadata_by_index_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_ncp_fw_list_class_id,
                                       sli_btmesh_ncp_fw_list_get_fw_metadata_by_index_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                         ...
                                         uint16_t *fw_list_index)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_ncp_fw_list_add_fw_t) + fwid_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_ncp_fw_list_class_id,
                                       sli_btmesh_ncp_fw_list_add_fw_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  const uint8_t* metadata)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_ncp_fw_list_set_fw_metadata_t) + metadata_len;
    if (cmd_payload_len > SL_BGAPI_MAX_PAYLOAD_SIZE) {
        return SL_STATUS_COMMAND_TOO_LONG;
    }

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_ncp_fw_list_class_id,
                                       sli_btmesh_ncp_fw_list_set_fw_metadata_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_sar_config_client_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sar_config_client_class_id,
                                       sli_btmesh_sar_config_client_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_sar_config_client_deinit(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sar_config_client_class_id,
                                       sli_btmesh_sar_config_client_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                            ...
                                                            uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sar_config_client_get_sar_transmitter_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sar_config_client_class_id,
                                       sli_btmesh_sar_config_client_get_sar_transmitter_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                            ...
                                                            uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sar_config_client_set_sar_transmitter_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sar_config_client_class_id,
                                       sli_btmesh_sar_config_client_set_sar_transmitter_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                         ...
                                                         uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sar_config_client_get_sar_receiver_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sar_config_client_class_id,
                                       sli_btmesh_sar_config_client_get_sar_receiver_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                         ...
                                                         uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sar_config_client_set_sar_receiver_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sar_config_client_class_id,
                                       sli_btmesh_sar_config_client_set_sar_receiver_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_sar_config_server_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sar_config_server_class_id,
                                       sli_btmesh_sar_config_server_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_sar_config_server_deinit(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sar_config_server_class_id,
                                       sli_btmesh_sar_config_server_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                            ...
                                                            uint16_t *multicast_retrans_interval_step)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sar_config_server_class_id,
                                       sli_btmesh_sar_config_server_get_sar_transmitter_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                            ...
                                                            uint16_t multicast_retrans_interval_step)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sar_config_server_set_sar_transmitter_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sar_config_server_class_id,
                                       sli_btmesh_sar_config_server_set_sar_transmitter_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                         ...
                                                         uint8_t *ack_retrans_count)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sar_config_server_class_id,
                                       sli_btmesh_sar_config_server_get_sar_receiver_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                         ...
                                                         uint8_t ack_retrans_count)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_sar_config_server_set_sar_receiver_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_sar_config_server_class_id,
                                       sli_btmesh_sar_config_server_set_sar_receiver_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_private_beacon_client_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_private_beacon_client_class_id,
                                       sli_btmesh_private_beacon_client_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_private_beacon_client_deinit(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_private_beacon_client_class_id,
                                       sli_btmesh_private_beacon_client_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                       ...
                                                       uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_private_beacon_client_get_beacon_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_private_beacon_client_class_id,
                                       sli_btmesh_private_beacon_client_get_beacon_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                       ...
                                                       uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_private_beacon_client_set_beacon_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_private_beacon_client_class_id,
                                       sli_btmesh_private_beacon_client_set_beacon_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                           ...
                                                           uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_private_beacon_client_get_gatt_proxy_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_private_beacon_client_class_id,
                                       sli_btmesh_private_beacon_client_get_gatt_proxy_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                           ...
                                                           uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_private_beacon_client_set_gatt_proxy_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_private_beacon_client_class_id,
                                       sli_btmesh_private_beacon_client_set_gatt_proxy_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                         ...
                                                         uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_private_beacon_client_get_identity_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_private_beacon_client_class_id,
                                       sli_btmesh_private_beacon_client_get_identity_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                         ...
                                                         uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_private_beacon_client_set_identity_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_private_beacon_client_class_id,
                                       sli_btmesh_private_beacon_client_set_identity_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_private_beacon_server_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_private_beacon_server_class_id,
                                       sli_btmesh_private_beacon_server_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_private_beacon_server_deinit(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_private_beacon_server_class_id,
                                       sli_btmesh_private_beacon_server_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_lcd_client_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lcd_client_class_id,
                                       sli_btmesh_lcd_client_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_lcd_client_deinit(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lcd_client_class_id,
                                       sli_btmesh_lcd_client_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                      ...
                                                      uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lcd_client_get_composition_data_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lcd_client_class_id,
                                       sli_btmesh_lcd_client_get_composition_data_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                              ...
                                              uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_lcd_client_get_metadata_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lcd_client_class_id,
                                       sli_btmesh_lcd_client_get_metadata_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_lcd_server_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lcd_server_class_id,
                                       sli_btmesh_lcd_server_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_lcd_server_deinit(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_lcd_server_class_id,
                                       sli_btmesh_lcd_server_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_on_demand_private_proxy_client_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_on_demand_private_proxy_client_class_id,
                                       sli_btmesh_on_demand_private_proxy_client_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_on_demand_private_proxy_client_deinit(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_on_demand_private_proxy_client_class_id,
                                       sli_btmesh_on_demand_private_proxy_client_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                                                      ...
                                                                                      uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_on_demand_private_proxy_client_get_on_demand_private_gatt_proxy_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_on_demand_private_proxy_client_class_id,
                                       sli_btmesh_on_demand_private_proxy_client_get_on_demand_private_gatt_proxy_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                                                      ...
                                                                                      uint32_t *handle)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_on_demand_private_proxy_client_set_on_demand_private_gatt_proxy_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_on_demand_private_proxy_client_class_id,
                                       sli_btmesh_on_demand_private_proxy_client_set_on_demand_private_gatt_proxy_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_solicitation_config_client_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_solicitation_config_client_class_id,
                                       sli_btmesh_solicitation_config_client_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_solicitation_config_client_deinit(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_solicitation_config_client_class_id,
                                       sli_btmesh_solicitation_config_client_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                             ...
                                                             uint8_t response_required)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_solicitation_config_client_clear_items_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_solicitation_config_client_class_id,
                                       sli_btmesh_solicitation_config_client_clear_items_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_on_demand_private_proxy_server_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_on_demand_private_proxy_server_class_id,
                                       sli_btmesh_on_demand_private_proxy_server_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_on_demand_private_proxy_server_deinit(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_on_demand_private_proxy_server_class_id,
                                       sli_btmesh_on_demand_private_proxy_server_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_silabs_config_server_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_silabs_config_server_class_id,
                                       sli_btmesh_silabs_config_server_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                  ...
                                                  uint32_t options)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_silabs_config_server_set_tx_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_silabs_config_server_class_id,
                                       sli_btmesh_silabs_config_server_set_tx_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                  ...
                                                  uint32_t *options)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_silabs_config_server_class_id,
                                       sli_btmesh_silabs_config_server_get_tx_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                            ...
                                                            uint16_t value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_silabs_config_server_set_model_enable_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_silabs_config_server_class_id,
                                       sli_btmesh_silabs_config_server_set_model_enable_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
                                                            ...
                                                            uint16_t *value)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_silabs_config_server_get_model_enable_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_silabs_config_server_class_id,
                                       sli_btmesh_silabs_config_server_get_model_enable_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_silabs_config_server_set_network_pdu(uint16_t max_size)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_silabs_config_server_set_network_pdu_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_silabs_config_server_class_id,
                                       sli_btmesh_silabs_config_server_set_network_pdu_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_silabs_config_server_get_network_pdu(uint16_t *max_size)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_silabs_config_server_class_id,
                                       sli_btmesh_silabs_config_server_get_network_pdu_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_diagnostic_init(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_diagnostic_class_id,
                                       sli_btmesh_diagnostic_init_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_diagnostic_deinit(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_diagnostic_class_id,
                                       sli_btmesh_diagnostic_deinit_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_diagnostic_enable_relay(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_diagnostic_class_id,
                                       sli_btmesh_diagnostic_enable_relay_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_diagnostic_disable_relay(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_diagnostic_class_id,
                                       sli_btmesh_diagnostic_disable_relay_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_diagnostic_get_relay(uint32_t *relay_counter)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_diagnostic_class_id,
                                       sli_btmesh_diagnostic_get_relay_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                                ...
                                                uint8_t *statistics)
{
    struct sl_btmesh_packet *cmd = (struct sl_btmesh_packet *)sl_btmesh_cmd_msg;
    struct sl_btmesh_packet *rsp = (struct sl_btmesh_packet *)sl_btmesh_rsp_msg;
    size_t cmd_payload_len = sizeof(sl_btmesh_cmd_diagnostic_get_statistics_t);

    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_diagnostic_class_id,
                                       sli_btmesh_diagnostic_get_statistics_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
...
sl_status_t sl_btmesh_diagnostic_clear_statistics(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_diagnostic_class_id,
                                       sli_btmesh_diagnostic_clear_statistics_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_diagnostic_enable_friend(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_diagnostic_class_id,
                                       sli_btmesh_diagnostic_enable_friend_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_diagnostic_disable_friend(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_diagnostic_class_id,
                                       sli_btmesh_diagnostic_disable_friend_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
                                            ...
                                            uint32_t *remove_counter_old_segment)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_diagnostic_class_id,
                                       sli_btmesh_diagnostic_get_friend_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
...
sl_status_t sl_btmesh_model_migration_migrate_models(void)
{
    ...
    cmd->header = SLI_BGAPI_MSG_HEADER(sli_btmesh_model_migration_class_id,
                                       sli_btmesh_model_migration_migrate_models_command_id,
                                       (uint8_t) sl_bgapi_msg_type_cmd | (uint8_t) sl_bgapi_dev_type_btmesh,
                                       cmd_payload_len);
    sl_btmesh_host_handle_command();
