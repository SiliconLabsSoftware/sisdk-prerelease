                                                       ...
                                                       sl_rtl_cs_algo_mode        mode)
{
  ...
  rc = sl_rtl_cs_set_algo_mode(&inst->libitem, mode);
  (void)app_rta_release(ctx->rta_ctx);
  return rc;
}
                                                  ...
                                                  sl_rtl_cs_mode             sub_mode)
{
  ...
  rc = sl_rtl_cs_set_cs_mode(&inst->libitem, main_mode, sub_mode);
  (void)app_rta_release(ctx->rta_ctx);
  return rc;
}
                                                    ...
                                                    const sl_rtl_cs_params    *params)
{
  ...
  rc = sl_rtl_cs_set_cs_params(&inst->libitem, params);
  (void)app_rta_release(ctx->rta_ctx);
  return rc;
}
...
enum sl_rtl_error_code sl_rtl_service_create_cs_estimator(sl_rtl_service_cs_inst_t *inst)
{
  ...
  rc = sl_rtl_cs_create_estimator(&inst->libitem);
  (void)app_rta_release(ctx->rta_ctx);
  return rc;
}
...
enum sl_rtl_error_code sl_rtl_service_enable_cs_log(sl_rtl_service_cs_inst_t *inst)
{
  ...
  rc = sl_rtl_cs_log_enable(&inst->libitem);
  (void)app_rta_release(ctx->rta_ctx);
  return rc;
}
                                                             ...
                                                             const sl_rtl_cs_estimator_param *param)
{
  ...
  rc = sl_rtl_cs_set_estimator_param(&inst->libitem, param);
  (void)app_rta_release(ctx->rta_ctx);
  return rc;
}
