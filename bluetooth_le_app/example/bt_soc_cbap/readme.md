...
3. The CA certificate must be stored in the application, so you must copy the generated `~/.silabs/certificates/central_authority/sl_bt_cbap_root_cert.h` file into this project, under the `/config` folder.
