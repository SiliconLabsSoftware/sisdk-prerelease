...
static aoa_id_t mqtt_client_id = AOA_ID_T_DEFAULT_VALUE;
static aoa_id_t positioning_id = AOA_ID_T_DEFAULT_VALUE;
...
static void parse_locator_config(void)
{
  sl_status_t sc;
  aoa_locator_t *loc;
  aoa_id_t locator_id = AOA_ID_T_DEFAULT_VALUE;
...
static void on_message(mqtt_handle_t *handle,
                       ...
                       const char *payload)
{
  aoa_id_t pos_id = AOA_ID_T_DEFAULT_VALUE;
  aoa_id_t loc_id = AOA_ID_T_DEFAULT_VALUE;
  aoa_id_t tag_id = AOA_ID_T_DEFAULT_VALUE;
