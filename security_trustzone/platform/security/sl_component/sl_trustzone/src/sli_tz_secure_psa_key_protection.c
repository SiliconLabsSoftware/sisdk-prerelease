...
#include "sli_psa_key_protection_autogen.h"
...
static const sl_psa_key_range_t protected_ranges[] = SLI_PSA_KEY_PROTECTION_RANGES_INIT;

static bool sli_psa_key_id_is_protected(psa_key_id_t key_id)
{
  for (size_t i = 0; i < SL_PSA_KEY_PROTECTION_RANGE_COUNT; i++) {
