 ...
 */
int sx_aead_create_chacha20poly1305_enc(struct sxaead *c, const
    struct sxkeyref *key, const char *nonce);
 ...
 *           context saving.
 */
int sx_aead_create_chacha20poly1305_dec(struct sxaead *c, const
    struct sxkeyref *key, const char *nonce);
