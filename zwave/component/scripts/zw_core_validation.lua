...
--  1. configUSE_IDLE_HOOK must be set to 1 in zwave application
--  2. configTIMER_TASK_PRIORITY must be set to 55 in zwave application
--  3.1 configMAX_SYSCALL_INTERRUPT_PRIORITY must be set to 32 in zwave application for Series 1
--  3.2 configMAX_SYSCALL_INTERRUPT_PRIORITY must be set to 16 in zwave application for Series 2
