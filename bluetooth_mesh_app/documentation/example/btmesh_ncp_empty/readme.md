...
A C project is in the SDK folder `example_host/empty_btmesh`
...
2. Compile and start ncp_daemon in a new terminal:
   ...
   - Navigate to example_host/ncp_daemon in the Bt Mesh SDK.
...
3. Compile and start empty_btmesh in a new terminal:
   ...
   - Navigate to example_host/empty_btmesh in the Bt Mesh SDK.
   - Build the example by typing 'make'.
