# Bluetooth Mesh - SoC Sensor Thermometer FreeRTOS

The **Bluetooth Mesh - SoC Sensor Thermometer FreeRTOS** example is a working example application that you can use as a template for Bluetooth Mesh Sensor Server applications. The project is based on a Real Time Operating System, which in this case is FreeRTOS.
...
**Bluetooth Mesh - SoC Sensor Thermometer FreeRTOS** example makes various sensor measurements and forwards them to another node implementing the sensor client. This example measures and displays occupancy (people count) sensor data, temperature data and illuminance (on Thunderboard Sense 2).
...
## Testing the Bluetooth Mesh - SoC Sensor Thermometer FreeRTOS Application

To test the application, do the following:

1. Make sure a bootloader is installed. See the Troubleshooting section.
2. Build and flash the **Bluetooth Mesh - SoC Sensor Thermometer FreeRTOS** example to your device.
