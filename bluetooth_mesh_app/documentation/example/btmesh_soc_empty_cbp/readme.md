...
2. Create a CA certificate. Skip this step if you already have a root certificate you wish to use. Install the Python modules cryptography and jinja2 as follows:
    ...
    - `python3 {SDK_folder}/bluetooth_mesh_app/script/certificate_authorities/create_authority_certificate.py`

    The CA certificate can now be found in `{SDK_folder}/bluetooth_mesh_app/script/certificate_authorities/central_authority/certificate.pem`.

3. Run the production_line_tool.py python script on your computer with the following parameters:
    - `python3 {SDK_folder}/bluetooth_mesh_app/script/certificate_authorities/production_line_tool.py --serial <serialnumber>`
