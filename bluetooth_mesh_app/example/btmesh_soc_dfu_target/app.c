/***************************************************************************//**
 * @file
 * @brief Silicon Labs SoC BT Mesh DFU Target Example Project
 *******************************************************************************
 * # License
...
void app_init(void)
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  app_log("Bt Mesh Target Node initialized" APP_LOG_NL);
...
void sl_btmesh_factory_reset_on_full_reset(void)
{
  ...
  // Delete all BLOBs from BLOB storage (firmware images)
