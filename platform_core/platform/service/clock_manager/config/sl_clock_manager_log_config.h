/***************************************************************************//**
 * @file
 * @brief Clock Manager - Tracing configuration file.
 *******************************************************************************
 * # License
...
#ifndef SL_CLOCK_MANAGER_LOG_CONFIG_H
#define SL_CLOCK_MANAGER_LOG_CONFIG_H

// <o SL_CLOCK_MANAGER_LOG_LEVEL_COMPILE_TIME> Clock Manager Log Level
// <SL_LOG_CONFIG_LEVEL_NONE  => NONE  (all Clock Manager logs compiled out)
...
#endif /* SL_CLOCK_MANAGER_LOG_CONFIG_H */
