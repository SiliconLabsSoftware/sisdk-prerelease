...
#elif defined(SL_CLOCK_MANAGER_DEFAULT_HF_CLOCK_SOURCE_HFRCODPLL1) \
  && (SL_CLOCK_MANAGER_DEFAULT_HF_CLOCK_SOURCE == SL_CLOCK_MANAGER_DEFAULT_HF_CLOCK_SOURCE_HFRCODPLL1)
#define SL_CLOCK_MANAGER_DEFAULT_HF_CLOCK_SOURCE_CONCATENATION      _HFRCODPLL1
...
#if defined(SL_CLOCK_MANAGER_HFRCO1_BAND)
#define SLI_CLOCK_MANAGER_HFRCO1_BAND      SL_CLOCK_MANAGER_HFRCO1_BAND
#define SLI_CLOCK_MANAGER_HFRCO_DPLL1_EN   SL_CLOCK_MANAGER_HFRCO_DPLL1_EN
#define SLI_CLOCK_MANAGER_DPLL1_FREQ       SL_CLOCK_MANAGER_DPLL1_FREQ
#define SLI_CLOCK_MANAGER_DPLL1_N          SL_CLOCK_MANAGER_DPLL1_N
#define SLI_CLOCK_MANAGER_DPLL1_M          SL_CLOCK_MANAGER_DPLL1_M
#endif
...
/***************************************************************************//**
 * Pre-initializes internal oscillators.
 * This is called in sli_clock_manager_hal_init() before other oscillators
 * are initialized.
 ******************************************************************************/
SL_WEAK void sli_clock_manager_hal_preinit_oscillators_internal(void);
