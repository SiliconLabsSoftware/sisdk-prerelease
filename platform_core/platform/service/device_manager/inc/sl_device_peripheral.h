 ...
 *
 * @param dma_peripheral  A pointer to DMA peripheral.
 *
 * @return  The DMA channel count
 ******************************************************************************/
inline uint8_t sl_device_peripheral_get_dma_channel_count(const sl_peripheral_dma_t dma_peripheral)
{
  return dma_peripheral->nbr_channel;
}
 ...
 ******************************************************************************/
inline uint8_t sl_device_peripheral_get_dma_sync_count(const sl_peripheral_dma_t dma_peripheral)
{
  return dma_peripheral->nbr_sync;
}
 ...
 ******************************************************************************/
inline uint32_t sl_device_peripheral_get_dma_dual_destination_bitmap(const sl_peripheral_dma_t dma_peripheral)
{
  return dma_peripheral->dual_destination_map;
}
 ...
 ******************************************************************************/
inline uint32_t sl_device_peripheral_get_dma_interleaving_bitmap(const sl_peripheral_dma_t dma_peripheral)
{
  return dma_peripheral->rule_based_interleaving_map;
}
