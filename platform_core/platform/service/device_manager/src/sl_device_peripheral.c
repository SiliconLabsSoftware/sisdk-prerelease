...
/***************************************************************************//**
 * @addtogroup device_dma Device Abstraction DMA
 * @{
 ******************************************************************************/
...
extern uint8_t sl_device_peripheral_get_dma_channel_count(const sl_peripheral_dma_t dma_peripheral);

// External DMA SYNC count getter declaration.
extern uint8_t sl_device_peripheral_get_dma_sync_count(const sl_peripheral_dma_t dma_peripheral);

// External DMA dual destination bitmap getter declaration.
extern uint32_t sl_device_peripheral_get_dma_dual_destination_bitmap(const sl_peripheral_dma_t dma_peripheral);

// External DMA interleaving bitmap getter declaration.
extern uint32_t sl_device_peripheral_get_dma_interleaving_bitmap(const sl_peripheral_dma_t dma_peripheral);
