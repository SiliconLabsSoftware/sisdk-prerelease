...
#if (defined(_SILICON_LABS_SECURITY_FEATURE) \
  && (_SILICON_LABS_SECURITY_FEATURE == _SILICON_LABS_SECURITY_FEATURE_VAULT))
  #if (defined(_SILICON_LABS_32B_SERIES_3_CONFIG_301) || (defined(_SILICON_LABS_32B_SERIES_2)))
    #define SLI_SE_SUPPORTS_VOLATILE_KEY_STORAGE
  #endif
  #if !defined(_SILICON_LABS_32B_SERIES_3_CONFIG_301)
    #define SLI_SE_SUPPORTS_LARGER_THAN_256_BIT_KEYS
  #endif
  #if defined(_SILICON_LABS_32B_SERIES_3)
    #define SLI_SE_SUPPORTS_KSU_KEY_STORAGE
  #endif
#endif
