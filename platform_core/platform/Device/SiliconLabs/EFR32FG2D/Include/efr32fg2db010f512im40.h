 ...
 *
 *****************************************************************************/
#ifndef EFR32FG2DB010F512IM40_H
#define EFR32FG2DB010F512IM40_H
...
/**************************************************************************//**
 * @defgroup EFR32FG2DB010F512IM40 EFR32FG2DB010F512IM40
 * @{
 *****************************************************************************/
...
typedef enum IRQn{
  ...
  /******  EFR32FG2D Peripheral Interrupt Numbers ******************************************/
...
/**************************************************************************//**
 * @defgroup EFR32FG2DB010F512IM40_Core EFR32FG2DB010F512IM40 Core
 * @{
...
/** @} End of group EFR32FG2DB010F512IM40_Core */

/**************************************************************************//**
* @defgroup EFR32FG2DB010F512IM40_Part EFR32FG2DB010F512IM40 Part
* @{
******************************************************************************/
...
#if !defined(EFR32FG2DB010F512IM40)
#define EFR32FG2DB010F512IM40    1 /**< FULL Part */
#endif

/** Configure part number */
#define PART_NUMBER                                        "EFR32FG2DB010F512IM40" /**< Part Number */
...
#define _SILICON_LABS_32B_SERIES_2_CONFIG_13                                                    /** Product Config Identifier */
#define _SILICON_LABS_32B_SERIES_2_CONFIG                  13                                   /** Product Config Identifier */
#define _SILICON_LABS_GECKO_INTERNAL_SDID                  260                                  /** Silicon Labs internal use only */
#define _SILICON_LABS_GECKO_INTERNAL_SDID_260                                                   /** Silicon Labs internal use only */
...
/** Flash and SRAM limits for EFR32FG2DB010F512IM40 */
...
#define EXT_IRQ_COUNT                                      78             /**< Number of External (NVIC) interrupts */
...
#define GPIO_EM4WU_PINS_MASK                               0x03C90000UL  /**< Mask of EM4WU pins available on this OPN.*/
#define GPIO_EM4WU_PIN_COUNT                               6U            /**< Number of EM4WU pins available on this OPN.*/
...
#include "system_efr32fg2d.h" /* System Header File */

/** @} End of group EFR32FG2DB010F512IM40_Part */

/**************************************************************************//**
 * @defgroup EFR32FG2DB010F512IM40_Peripheral_TypeDefs EFR32FG2DB010F512IM40 Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/
#include "efr32fg2d_scratchpad.h"
#include "efr32fg2d_emu.h"
#include "efr32fg2d_cmu.h"
#include "efr32fg2d_hfrco.h"
#include "efr32fg2d_fsrco.h"
#include "efr32fg2d_dpll.h"
#include "efr32fg2d_lfxo.h"
#include "efr32fg2d_lfrco.h"
#include "efr32fg2d_ulfrco.h"
#include "efr32fg2d_msc.h"
#include "efr32fg2d_icache.h"
#include "efr32fg2d_prs.h"
#include "efr32fg2d_gpio.h"
#include "efr32fg2d_ldma.h"
#include "efr32fg2d_ldmaxbar.h"
#include "efr32fg2d_timer.h"
#include "efr32fg2d_usart.h"
#include "efr32fg2d_burtc.h"
#include "efr32fg2d_i2c.h"
#include "efr32fg2d_syscfg.h"
#include "efr32fg2d_buram.h"
#include "efr32fg2d_gpcrc.h"
#include "efr32fg2d_dcdc.h"
#include "efr32fg2d_mailbox.h"
#include "efr32fg2d_eusart.h"
#include "efr32fg2d_sysrtc.h"
#include "efr32fg2d_keyscan.h"
#include "efr32fg2d_mpahbram.h"
#include "efr32fg2d_pfmxpprf.h"
#include "efr32fg2d_wdog.h"
#include "efr32fg2d_aes.h"
#include "efr32fg2d_smu.h"
#include "efr32fg2d_letimer.h"
#include "efr32fg2d_iadc.h"
#include "efr32fg2d_acmp.h"
#include "efr32fg2d_vdac.h"
#include "efr32fg2d_pcnt.h"
#include "efr32fg2d_lesense.h"
#include "efr32fg2d_hfxo.h"
#include "efr32fg2d_semailbox.h"
#include "efr32fg2d_devinfo.h"

/* Custom headers for LDMAXBAR and PRS mappings */
#include "efr32fg2d_prs_signals.h"
#include "efr32fg2d_dma_descriptor.h"
#include "efr32fg2d_ldmaxbar_defines.h"

/** @} End of group EFR32FG2DB010F512IM40_Peripheral_TypeDefs  */

/**************************************************************************//**
 * @defgroup EFR32FG2DB010F512IM40_Peripheral_Base EFR32FG2DB010F512IM40 Peripheral Memory Map
 * @{
 *****************************************************************************/
...
#define WDOG0_S_BASE              (0x400C8000UL) /* WDOG0_S base address */
...
#define WDOG0_NS_BASE             (0x500C8000UL) /* WDOG0_NS base address */
...
/** @} End of group EFR32FG2DB010F512IM40_Peripheral_Base */

/**************************************************************************//**
 * @defgroup EFR32FG2DB010F512IM40_Peripheral_Declaration EFR32FG2DB010F512IM40 Peripheral Declarations Map
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32FG2DB010F512IM40_Peripheral_Declaration */

/**************************************************************************//**
 * @defgroup EFR32FG2DB010F512IM40_Peripheral_Parameters EFR32FG2DB010F512IM40 Peripheral Parameters
 * @{
...
#define DMEM_BANK10_SIZE                        0x0UL       /**> Bank10 size */
#define DMEM_BANK11_SIZE                        0x0UL       /**> Bank11 size */
#define DMEM_BANK12_SIZE                        0x0UL       /**> Bank12 size */
#define DMEM_BANK13_SIZE                        0x0UL       /**> Bank13 size */
#define DMEM_BANK14_SIZE                        0x0UL       /**> Bank14 size */
#define DMEM_BANK15_SIZE                        0x0UL       /**> Bank15 size */
...
#define DMEM_BANK8_SIZE                         0x0UL       /**> Bank8 size */
#define DMEM_BANK9_SIZE                         0x0UL       /**> Bank9 size */
#define DMEM_ECC_EXCLUDE                        0x0UL       /**> ECC exclude */
#define DMEM_MEM_SIZE                           0x10000UL   /**> Total memory size */
...
#define SYSCFG_CHIP_PARTNUMBER                  0x5UL       /**> Chip Part Number */
...
/** @} End of group EFR32FG2DB010F512IM40_Peripheral_Parameters  */

/** @} End of group EFR32FG2DB010F512IM40 */
/** @}} End of group Parts */
