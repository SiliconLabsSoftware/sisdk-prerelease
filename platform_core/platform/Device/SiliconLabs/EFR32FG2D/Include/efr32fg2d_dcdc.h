 ...
 *
 *****************************************************************************/
#ifndef EFR32FG2D_DCDC_H
#define EFR32FG2D_DCDC_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup EFR32FG2D_DCDC DCDC
 * @{
 * @brief EFR32FG2D DCDC Register Declaration.
 *****************************************************************************/
...
typedef struct dcdc_typedef{
  ...
  __IOM uint32_t DOCTRL;                        /**< Dual Output Control                                */
  ...
  uint32_t       RESERVED10[985U];              /**< Reserved for future use                            */
  __IM uint32_t  IPVERSION_SET;                 /**< IPVERSION                                          */
  __IOM uint32_t CTRL_SET;                      /**< Control                                            */
  __IOM uint32_t DOCTRL_SET;                    /**< Dual Output Control                                */
  ...
  uint32_t       RESERVED21[985U];              /**< Reserved for future use                            */
  __IM uint32_t  IPVERSION_CLR;                 /**< IPVERSION                                          */
  __IOM uint32_t CTRL_CLR;                      /**< Control                                            */
  __IOM uint32_t DOCTRL_CLR;                    /**< Dual Output Control                                */
  ...
  uint32_t       RESERVED32[985U];              /**< Reserved for future use                            */
  __IM uint32_t  IPVERSION_TGL;                 /**< IPVERSION                                          */
  __IOM uint32_t CTRL_TGL;                      /**< Control                                            */
  __IOM uint32_t DOCTRL_TGL;                    /**< Dual Output Control                                */
...
/**************************************************************************//**
 * @addtogroup EFR32FG2D_DCDC
 * @{
 * @defgroup EFR32FG2D_DCDC_BitFields DCDC Bit Fields
 * @{
 *****************************************************************************/

/* Bit fields for DCDC IPVERSION */
#define _DCDC_IPVERSION_RESETVALUE                  0x00000007UL                             /**< Default value for DCDC_IPVERSION            */
...
#define _DCDC_IPVERSION_IPVERSION_DEFAULT           0x00000007UL                             /**< Mode DEFAULT for DCDC_IPVERSION             */
...
#define _DCDC_DOCTRL_MASK                           0x800000F3UL                                  /**< Mask for DCDC_DOCTRL                        */
#define _DCDC_DOCTRL_REGULATIONTYPE_SHIFT           0                                             /**< Shift value for DCDC_REGULATIONTYPE         */
#define _DCDC_DOCTRL_REGULATIONTYPE_MASK            0x3UL                                         /**< Bit mask for DCDC_REGULATIONTYPE            */
#define _DCDC_DOCTRL_REGULATIONTYPE_DEFAULT         0x00000000UL                                  /**< Mode DEFAULT for DCDC_DOCTRL                */
...
#define DCDC_DOCTRL_DUALIPKEN_DEFAULT               (_DCDC_DOCTRL_DUALIPKEN_DEFAULT << 31)        /**< Shifted mode DEFAULT for DCDC_DOCTRL        */

/* Bit fields for DCDC EM01CTRL0 */
#define _DCDC_EM01CTRL0_RESETVALUE                  0x00000299UL                                    /**< Default value for DCDC_EM01CTRL0            */
...
#define _DCDC_EM23CTRL0_RESETVALUE                  0x00000233UL                                    /**< Default value for DCDC_EM23CTRL0            */
