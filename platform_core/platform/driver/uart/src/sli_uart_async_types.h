/***************************************************************************/ /**
 * @file
 * @brief Internal UART async transfer types and list helpers
 *******************************************************************************
 * # License
...
#ifndef SLI_UART_ASYNC_TYPES_H
#define SLI_UART_ASYNC_TYPES_H
...
{
  sli_uart_async_transfer_t *transfer = sli_uart_async_transfer_from_node(node);

  return container_of(transfer, sli_uart_async_rx_transfer_t, base);
}
...
static inline sli_uart_async_tx_transfer_t *sli_uart_async_tx_transfer_from_node(sl_slist_node_t *node)
{
  ...
  return container_of(transfer, sli_uart_async_tx_transfer_t, base);
}
