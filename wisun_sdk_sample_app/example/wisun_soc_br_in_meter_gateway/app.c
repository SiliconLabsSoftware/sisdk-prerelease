...
static void app_start(void)
{
  ...
  EFM_ASSERT((sl_wisun_stoip6_prefix(SL_WISUN_BR_CONFIG_IPV6_PREFIX, ipv6_prefix, &ipv6_prefix_length) >= 0)
  ...
  // Get channel mask
  EFM_ASSERT(app_settings_get_channel_mask(WISUN_CONFIG_ALLOWED_CHANNELS,
