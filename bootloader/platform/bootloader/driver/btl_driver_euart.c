...
void uart_init(void)
{
  ...
  GPIO->EUARTROUTE_SET[0].ROUTEEN = GPIO_EUART_ROUTEEN_RTSPEN;
  ...
  GPIO->EUARTROUTE[0].TXROUTE = (SL_SERIAL_EUART_TX_PORT
                                 << _GPIO_EUART_TXROUTE_PORT_SHIFT)
                                | (SL_SERIAL_EUART_TX_PIN << _GPIO_EUART_TXROUTE_PIN_SHIFT);
  GPIO->EUARTROUTE[0].RXROUTE = (SL_SERIAL_EUART_RX_PORT
