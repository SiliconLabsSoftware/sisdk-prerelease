...
This project shows how to use the FG23, PG23 and PG28 LCD peripheral with the LDMA on the
BRD2504A, BRD2600A and BRD2506A boards, respectively, to update the segment LCD in EM2 using a custom segment LCD
driver.
