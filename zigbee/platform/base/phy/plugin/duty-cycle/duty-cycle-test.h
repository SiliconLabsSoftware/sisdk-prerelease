...
typedef struct EmPhyDutyCycle {
  ...
  uint64_t dcLastBucketStartMsTick;       // Most recent bucket's start time
 ...
 */
extern void sli_802154phy_dc_set_time_accel(uint16_t timeAccel);

/** @brief Get the current time acceleration factor.
 * @return The time multiplier previously set via sli_802154phy_dc_set_time_accel().
 */
