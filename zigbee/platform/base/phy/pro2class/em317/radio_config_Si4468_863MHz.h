...
// INPUT DATA
/*
// Crys_freq(Hz): 30400000    Crys_tol(ppm): 20    IF_mode: 2    High_perf_Ch_Fil: 1    OSRtune: 0    Ch_Fil_Bw_AFC: 0    ANT_DIV: 0    PM_pattern: 0    
// MOD_type: 3    Rsymb(sps): 100000    Fdev(Hz): 35000    RXBW(Hz): 150000    Manchester: 0    AFC_en: 1    Rsymb_error: 0.0    Chip-Version: 2    
// RF Freq.(MHz): 857.25    API_TC: 29    fhst: 200000    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1    
// Fdev_error: 0    API_ARR_Det_en: 0    API_ETSI: 0    
// 
// # WB filter 3 (BW = 187.69 kHz);  NB-filter 3 (BW = 187.69 kHz) 
// 
// Modulation index: 0
*/
...
#define RADIO_CONFIGURATION_DATA_RADIO_XO_FREQ                     30400000L
#define RADIO_CONFIGURATION_DATA_CHANNEL_NUMBER                    0x1E
...
*/
#define RF_POWER_UP 0x02, 0x01, 0x00, 0x01, 0xCF, 0xDE, 0x00
...
*/
#define RF_FRR_CTL_A_MODE_4 0x11, 0x02, 0x04, 0x00, 0x00, 0x00, 0x09, 0x0A
...
*/
#define RF_PKT_LEN_12 0x11, 0x12, 0x0C, 0x08, 0x0A, 0x01, 0x00, 0x30, 0x30, 0x00, 0x01, 0x04, 0x80, 0x00, 0x3C, 0x00
...
*/
#define RF_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x03, 0x00, 0x07, 0x1E, 0x84, 0x80, 0x09, 0xCF, 0xDE, 0x00, 0x00, 0x04
...
*/
#define RF_MODEM_FREQ_DEV_0_1 0x11, 0x20, 0x01, 0x0C, 0xB7
...
/*
// Set properties:           RF_MODEM_IF_FREQ_2_6
// Number of properties:     6
// Group ID:                 0x20
// Start ID:                 0x1B
// Default values:           0x03, 0xC0, 0x00, 0x10, 0x20, 0x00, 
// Descriptions:
...
*/
#define RF_MODEM_IF_FREQ_2_6 0x11, 0x20, 0x06, 0x1B, 0x03, 0xC0, 0x00, 0x10, 0x20, 0x00
...
*/
#define RF_MODEM_BCR_OSR_1_9 0x11, 0x20, 0x09, 0x22, 0x00, 0x4C, 0x06, 0xBC, 0xA2, 0x07, 0xFF, 0x02, 0x00
...
*/
#define RF_MODEM_AFC_GEAR_7 0x11, 0x20, 0x07, 0x2C, 0x00, 0x12, 0x80, 0x6C, 0x05, 0xFF, 0xE0
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_12 0x11, 0x20, 0x0C, 0x38, 0x11, 0x11, 0x11, 0x80, 0x1A, 0x2C, 0xCD, 0x00, 0x28, 0x0C, 0xA4, 0x03

/*
// Set properties:           RF_MODEM_RAW_CONTROL_7
// Number of properties:     7
// Group ID:                 0x20
// Start ID:                 0x45
// Default values:           0x02, 0x00, 0xA3, 0x02, 0x80, 0xFF, 0x0C, 
// Descriptions:
...
*/
#define RF_MODEM_RAW_CONTROL_7 0x11, 0x20, 0x07, 0x45, 0x03, 0x00, 0xBF, 0x02, 0x80, 0x7F, 0x0C

/*
// Set properties:           RF_MODEM_RSSI_JUMP_THRESH_2
// Number of properties:     2
// Group ID:                 0x20
// Start ID:                 0x4B
// Default values:           0x0C, 0x01, 
// Descriptions:
//   MODEM_RSSI_JUMP_THRESH - Configures the RSSI Jump Detection threshold.
//   MODEM_RSSI_CONTROL - Control of the averaging modes and latching time for reporting RSSI value(s).
*/
//RAIL_LIB-6298: this set of properties is redundant with above and below sets
#define RF_MODEM_RSSI_JUMP_THRESH_2 0x11, 0x20, 0x02, 0x4B, 0x0C, 0x02
...
//   MODEM_RSSI_COMP - RSSI compensation value. <-- Removed per RAIL_LIB-6298
*/
//#define RF_MODEM_RSSI_CONTROL_3 0x11, 0x20, 0x03, 0x4C, 0x02, 0x00, 0x40
#define RF_MODEM_RSSI_CONTROL_3 0x11, 0x20, 0x02, 0x4C, 0x02, 0x00
...
// Descriptions:
//   MODEM_SPIKE_DET - (G)FSK Spike Detection
//   MODEM_ONE_SHOT_AFC - One Shot AFC algorithm
*/
...
// Descriptions:
//   MODEM_DSA_CTRL1 - Signal Arrival Detection Control 1
//   MODEM_DSA_CTRL2 - Signal Arrival Detection Control 2
//   MODEM_DSA_QUAL - Signal Arrival Detect Qualifier config
//   MODEM_DSA_RSSI - Signal Arrival Detect RSSI Qualifier Config
//   MODEM_DSA_MISC - Miscellaneous detection of signal arrival bits.
*/
#define RF_MODEM_DSA_CTRL1_5 0x11, 0x20, 0x05, 0x5B, 0x42, 0x05, 0x04, 0x78, 0x20
...
*/
#define RF_PA_MODE_4 0x11, 0x22, 0x04, 0x00, 0x04, 0x7F, 0x00, 0x5D
...
*/
#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x37, 0x0B, 0x2F, 0x28, 0x1A, 0xF3, 0x20, 0xFF
...
#define RADIO_CONFIGURATION_DATA_ARRAY { \
        ...
        0x0A, RF_MODEM_IF_FREQ_2_6, \
        0x0D, RF_MODEM_BCR_OSR_1_9, \
        0x0B, RF_MODEM_AFC_GEAR_7, \
        0x05, RF_MODEM_AGC_CONTROL_1, \
        0x10, RF_MODEM_AGC_WINDOW_SIZE_12, \
        0x0B, RF_MODEM_RAW_CONTROL_7, \
        0x06, RF_MODEM_RSSI_JUMP_THRESH_2, \
        0x06, RF_MODEM_RSSI_CONTROL_3, \
