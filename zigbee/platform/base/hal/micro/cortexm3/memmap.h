...
#elif defined(CORTEXM3_EM357) || defined(SL_ZIGBEE_TEST)
...
#if !defined(SL_ZIGBEE_AAT_USE_8BIT_PAGE_NUMBERS)   \
  && !defined(SL_ZIGBEE_AAT_USE_16BIT_PAGE_NUMBERS) \
  && !defined(LOADER)
  #if (MFB_SIZE_B / MFB_PAGE_SIZE_B) > 256
// If the part we are building for has more than 256 pages in the MFB.
// default to 16 bits.
    #define SL_ZIGBEE_AAT_USE_16BIT_PAGE_NUMBERS
  #else
// For now, default to 8 bits on smaller parts. This may change soon.
    #define SL_ZIGBEE_AAT_USE_8BIT_PAGE_NUMBERS
  #endif
#endif
...
#elif defined(SL_ZIGBEE_AAT_USE_16BIT_PAGE_NUMBERS)
