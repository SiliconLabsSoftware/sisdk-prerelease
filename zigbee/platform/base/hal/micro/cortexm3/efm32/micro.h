...
#define SL_ZIGBEE_SPI_MASTER 4
#define SL_ZIGBEE_SPI_SLAVE 5
#define SL_ZIGBEE_I2C 6
 ...
 * default purpose.
 *
 * @return SL_ZIGBEE_SUCCESS if Radio HoldOff was configured as desired
 * or SL_ZIGBEE_BAD_ARGUMENT if requesting it be enabled but RHO has not
