...
/* *INDENT-OFF**/
    ...
    SEGMENT()
    SEGMENT2()
    EXCEPTION(     16,     SMU_SECURE_IRQHandler,       SMU_SECURE_IRQn,     SMU_SECURE_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     17, SMU_PRIVILEGED_IRQHandler,   SMU_S_PRIVILEGED_IRQn, SMU_PRIVILEGED_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     18,SMU_NS_PRIVILEGED_IRQHandler,SMU_NS_PRIVILEGED_IRQn,SMU_NS_PRIVILEGED_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     19,            EMU_IRQHandler,              EMU_IRQn,            EMU_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     20,         TIMER0_IRQHandler,           TIMER0_IRQn,         TIMER0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     21,         TIMER1_IRQHandler,           TIMER1_IRQn,         TIMER1_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     22,         TIMER2_IRQHandler,           TIMER2_IRQn,         TIMER2_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     23,         TIMER3_IRQHandler,           TIMER3_IRQn,         TIMER3_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     24,         TIMER4_IRQHandler,           TIMER4_IRQn,         TIMER4_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     25,      USART0_RX_IRQHandler,        USART0_RX_IRQn,      USART0_RX_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     26,      USART0_TX_IRQHandler,        USART0_TX_IRQn,      USART0_TX_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     27,     EUSART0_RX_IRQHandler,       EUSART0_RX_IRQn,     EUSART0_RX_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     28,     EUSART0_TX_IRQHandler,       EUSART0_TX_IRQn,     EUSART0_TX_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     29,     EUSART1_RX_IRQHandler,       EUSART1_RX_IRQn,     EUSART1_RX_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     30,     EUSART1_TX_IRQHandler,       EUSART1_TX_IRQn,     EUSART1_TX_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     31,            MVP_IRQHandler,              15/*MVP_IRQn*/,            MVP_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     32,        ICACHE0_IRQHandler,          ICACHE0_IRQn,        ICACHE0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     33,          BURTC_IRQHandler,            BURTC_IRQn,          BURTC_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     34,        LETIMER_IRQHandler,         LETIMER0_IRQn,       LETIMER0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     35,         SYSCFG_IRQHandler,           SYSCFG_IRQn,         SYSCFG_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     36,       MPAHBRAM_IRQHandler,         MPAHBRAM_IRQn,       MPAHBRAM_IRQHandler,             4,         0)
    ...
    SEGMENT()
    SEGMENT2()
    EXCEPTION(     46,            AGC_IRQHandler,              AGC_IRQn,            AGC_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     47,           BUFC_IRQHandler,             BUFC_IRQn,           BUFC_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     48,        FRC_PRI_IRQHandler,          FRC_PRI_IRQn,        FRC_PRI_IRQHandler,             3,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     49,            FRC_IRQHandler,              FRC_IRQn,            FRC_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     50,          MODEM_IRQHandler,            MODEM_IRQn,          MODEM_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     51,       PROTIMER_IRQHandler,         PROTIMER_IRQn,       PROTIMER_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     52,        RAC_RSM_IRQHandler,          RAC_RSM_IRQn,        RAC_RSM_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     53,        RAC_SEQ_IRQHandler,          RAC_SEQ_IRQn,        RAC_SEQ_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     54,    HOSTMAILBOX_IRQHandler,      HOSTMAILBOX_IRQn,    HOSTMAILBOX_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     55,          SYNTH_IRQHandler,            SYNTH_IRQn,          SYNTH_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     56,          ACMP0_IRQHandler,            ACMP0_IRQn,          ACMP0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     57,          ACMP1_IRQHandler,            ACMP1_IRQn,          ACMP1_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     58,          WDOG0_IRQHandler,            WDOG0_IRQn,          WDOG0_IRQHandler,             1,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     59,          WDOG1_IRQHandler,            WDOG1_IRQn,          WDOG1_IRQHandler,             1,         0)
    ...
    SEGMENT()
    SEGMENT2()
    EXCEPTION(     62,      HFRCOEM23_IRQHandler,        HFRCOEM23_IRQn,      HFRCOEM23_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     63,            CMU_IRQHandler,              CMU_IRQn,            CMU_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     64,            AES_IRQHandler,              AES_IRQn,            AES_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     65,           IADC_IRQHandler,             IADC_IRQn,           IADC_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     66,            MSC_IRQHandler,              MSC_IRQn,            MSC_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     67,          DPLL0_IRQHandler,            DPLL0_IRQn,          DPLL0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     68,         EMUEFP_IRQHandler,           EMUEFP_IRQn,         EMUEFP_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     69,           DCDC_IRQHandler,             DCDC_IRQn,           DCDC_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     70,          PCNT0_IRQHandler,            PCNT0_IRQn,          PCNT0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     71,            SW0_IRQHandler,              SW0_IRQn,            SW0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     72,            SW1_IRQHandler,              SW1_IRQn,            SW1_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     73,            SW2_IRQHandler,              SW2_IRQn,            SW2_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     74,            SW3_IRQHandler,              SW3_IRQn,            SW3_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     75,        KERNEL0_IRQHandler,          KERNEL0_IRQn,        KERNEL0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     76,        KERNEL1_IRQHandler,          KERNEL1_IRQn,        KERNEL1_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     77,         FPUEXH_IRQHandler,           FPUEXH_IRQn,         FPUEXH_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     78,   SETAMPERHOST_IRQHandler,     64/*SETAMPERHOST_IRQn*/,   SETAMPERHOST_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     79,         SEMBRX_IRQHandler,           SEMBRX_IRQn,         SEMBRX_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     80,         SEMBTX_IRQHandler,           SEMBTX_IRQn,         SEMBTX_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     81,     SYSRTC_APP_IRQHandler,       SYSRTC_APP_IRQn,     SYSRTC_APP_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     82,     SYSRTC_SEQ_IRQHandler,       SYSRTC_SEQ_IRQn,     SYSRTC_SEQ_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     83,        KEYSCAN_IRQHandler,          KEYSCAN_IRQn,        KEYSCAN_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     84,         RFECA0_IRQHandler,           RFECA0_IRQn,         RFECA0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     85,         RFECA1_IRQHandler,           RFECA1_IRQn,         RFECA1_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     86,          VDAC0_IRQHandler,            VDAC0_IRQn,          VDAC0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     87,          VDAC1_IRQHandler,            VDAC1_IRQn,          VDAC1_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     88,       AHB2AHB0_IRQHandler,         AHB2AHB0_IRQn,       AHB2AHB0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     89,       AHB2AHB1_IRQHandler,         AHB2AHB1_IRQn,       AHB2AHB1_IRQHandler,             4,         0)
