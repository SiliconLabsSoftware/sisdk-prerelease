 ...
 *
 * Some functions in this file return an ::sl_status_t value. See
 * sl_status.h for definitions of all ::sl_status_t return values.
 *
...
#define __TOKEN_H__
  ...
  #endif //MINIMAL_HAL
#elif ((defined(EZSP_HOST) || defined(UNIX_HOST)) && defined(SL_ZIGBEE_AF_API_TOKEN)) || (defined(SL_ZIGBEE_TEST) && !defined(ZIGBEE_STACK_ON_HOST))
#else
