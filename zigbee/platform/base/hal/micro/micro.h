...
/** @brief Called from sli_zigbee_stack_init and provides a means for the HAL
 ...
 *
 * @stackusage Called from sli_zigbee_stack_init only as helpful debugging information.
