...
static size_t getNvmOffset(uint16_t token, uint8_t index, uint8_t len);
  ...
  #if defined(SL_ZIGBEE_AF_DEVICE_NAME)
    #define SL_ZIGBEE_AF_TOKEN_FILENAME SL_ZIGBEE_AF_DEVICE_NAME ".nvm"
  #elif defined(ZA_PROMPT)
    #define SL_ZIGBEE_AF_TOKEN_FILENAME ZA_PROMPT ".nvm"
  #else
    #error SL_ZIGBEE_AF_TOKEN_FILENAME must be defined.
  #endif
#endif
