 ...
 *
 * This function returns ::SL_STATUS_OK and the duration parameter is
 ...
 * ::SL_STATUS_SUSPENDED and the duration parameter reports the amount of
 ...
 */
sl_status_t halSleepForQuarterSeconds(uint32_t *duration);
 ...
 * sleeping and return ::SL_STATUS_SUSPENDED.
 *
 ...
 *  failure of the command.
 */
sl_status_t halSleepForMilliseconds(uint32_t *duration);
