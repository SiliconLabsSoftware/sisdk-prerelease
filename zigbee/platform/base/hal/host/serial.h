 ...
 * using the SL_LEGACY_SERIAL_USE_STDIO variant of the Ember serial library.
 *
...
/** @brief This function enables/disables SL_LEGACY_SERIAL_USE_STDIO printing
 * behavior that is compatible with sli_legacy_serial_guaranteed_printf() and a
