...
const char *decode_sl_zigbee_ezsp_value_id_t(uint8_t value)
{
  switch (value) {
    ...
    case SL_ZIGBEE_EZSP_VALUE_STACK_REVISION: return "SL_ZIGBEE_EZSP_VALUE_STACK_REVISION";
  }
  return "*** Not enumerated. ***";
}
...
// Configuration Frames
    ...
    case SL_ZIGBEE_EZSP_SET_PENDING_NETWORK_UPDATE_CHANNEL: return "SL_ZIGBEE_EZSP_SET_PENDING_NETWORK_UPDATE_CHANNEL";
...
// Dynamic Hardware Configuration Frames
    case SL_ZIGBEE_EZSP_READ_PA_DESCRIPTOR: return "SL_ZIGBEE_EZSP_READ_PA_DESCRIPTOR";
    case SL_ZIGBEE_EZSP_WRITE_PA_DESCRIPTOR: return "SL_ZIGBEE_EZSP_WRITE_PA_DESCRIPTOR";
    case SL_ZIGBEE_EZSP_READ_PA_CURVE_SEGMENT: return "SL_ZIGBEE_EZSP_READ_PA_CURVE_SEGMENT";
    case SL_ZIGBEE_EZSP_WRITE_PA_CURVE_SEGMENT: return "SL_ZIGBEE_EZSP_WRITE_PA_CURVE_SEGMENT";
    case SL_ZIGBEE_EZSP_READ_PA_CURVE: return "SL_ZIGBEE_EZSP_READ_PA_CURVE";
    case SL_ZIGBEE_EZSP_WRITE_PA_CURVE: return "SL_ZIGBEE_EZSP_WRITE_PA_CURVE";
    case SL_ZIGBEE_EZSP_READ_PA_TABLE: return "SL_ZIGBEE_EZSP_READ_PA_TABLE";
    case SL_ZIGBEE_EZSP_WRITE_PA_TABLE: return "SL_ZIGBEE_EZSP_WRITE_PA_TABLE";
    case SL_ZIGBEE_EZSP_READ_RSSI_OFFSET: return "SL_ZIGBEE_EZSP_READ_RSSI_OFFSET";
    case SL_ZIGBEE_EZSP_WRITE_RSSI_OFFSET: return "SL_ZIGBEE_EZSP_WRITE_RSSI_OFFSET";
    case SL_ZIGBEE_EZSP_READ_PA_VOLTAGE: return "SL_ZIGBEE_EZSP_READ_PA_VOLTAGE";
    case SL_ZIGBEE_EZSP_WRITE_PA_VOLTAGE: return "SL_ZIGBEE_EZSP_WRITE_PA_VOLTAGE";
    case SL_ZIGBEE_EZSP_READ_PA_MODE: return "SL_ZIGBEE_EZSP_READ_PA_MODE";
    case SL_ZIGBEE_EZSP_WRITE_PA_MODE: return "SL_ZIGBEE_EZSP_WRITE_PA_MODE";
    case SL_ZIGBEE_EZSP_READ_CTUNE: return "SL_ZIGBEE_EZSP_READ_CTUNE";
    case SL_ZIGBEE_EZSP_WRITE_CTUNE: return "SL_ZIGBEE_EZSP_WRITE_CTUNE";
    case SL_ZIGBEE_EZSP_READ_DHC_VERSION: return "SL_ZIGBEE_EZSP_READ_DHC_VERSION";
    case SL_ZIGBEE_EZSP_WRITE_DHC_VERSION: return "SL_ZIGBEE_EZSP_WRITE_DHC_VERSION";
    case SL_ZIGBEE_EZSP_READ_PA_VERSION: return "SL_ZIGBEE_EZSP_READ_PA_VERSION";
    case SL_ZIGBEE_EZSP_WRITE_PA_VERSION: return "SL_ZIGBEE_EZSP_WRITE_PA_VERSION";
    case SL_ZIGBEE_EZSP_READ_PA_SIGNATURE: return "SL_ZIGBEE_EZSP_READ_PA_SIGNATURE";
    case SL_ZIGBEE_EZSP_WRITE_PA_SIGNATURE: return "SL_ZIGBEE_EZSP_WRITE_PA_SIGNATURE";
    case SL_ZIGBEE_EZSP_READ_PA_METADATA: return "SL_ZIGBEE_EZSP_READ_PA_METADATA";
    case SL_ZIGBEE_EZSP_WRITE_PA_METADATA: return "SL_ZIGBEE_EZSP_WRITE_PA_METADATA";
  }
  return "*** Not enumerated. ***";
}
