...
// <i> Default value 1232 (UDPv6 size without fragmentation)
#define SL_IPERF_BUFFER_SIZE                       1232U ///< Server receiver buffer size

// <o SL_IPERF_SOCKET_BUFFER_SIZE> Socket buffer size
// <i> Default value 1232 * 2. The socket has the capacity to contain 2 full iperf packets.
#define SL_IPERF_SOCKET_BUFFER_SIZE                SL_IPERF_BUFFER_SIZE * 2U ///< Socket buffer size
