...
Device
^^^^^^
This package provides a top-level device class, ``RM_Device_SIXG301XFULL_RevB1``,
...
register I/O or in a live session with a real part.
  ...
  .. autoclass::  RM_Device_SIXG301XFULL_RevB1
     :members:
     :show-inheritance:
     :inherited-members:
...
__all__ = [ 'RM_Device_SIXG301XFULL_RevB1' ]
...
class RM_Device_SIXG301XFULL_RevB1(Base_RM_Device):
    """
    ...
    def __init__(self, rmio=None, label='offline_rm', default_tz_access_mode=RM_TrustZone_Access_Mode.TZ_SECURE):
        ...
        super(RM_Device_SIXG301XFULL_RevB1, self).__init__(rmio, label,
            'SIXG301XFULL',
            RM_SVD_Info('SIXG301XFULL_SEQ.svd', '0d677063a4b0bf32a464f12f9527281e'))
