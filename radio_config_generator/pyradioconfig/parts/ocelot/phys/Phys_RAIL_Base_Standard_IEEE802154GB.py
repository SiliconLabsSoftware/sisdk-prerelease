...
class PHYS_IEEE802154_GB868_Ocelot(IPhy):

    def IEEE802154_GB868_154G_PHR(self, phy, model):
        # Great Britain smart metering PHY from 802.15.4g
        # refer to spec:
        # docs-13-0373-12-0mwg-868-gb-smart-meter-han-technical-requirements.doc
    ...
    def PHY_IEEE802154_915MHz_2GFSK_R23_NA(self, model, phy_name=None):
