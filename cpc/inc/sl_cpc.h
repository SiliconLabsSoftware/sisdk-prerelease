...
#define SL_CPC_MINOR_VERSION     10
 ...
 *
 * When an RTOS is present and no flag is specified, this function will block until the remote connects.
 * In baremetal this function will return immediately.
 *
