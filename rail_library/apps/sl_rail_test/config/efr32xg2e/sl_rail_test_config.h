/***************************************************************************//**
 * @file sl_rail_test_config.h
 * @brief RAILtest-style configuration for LionU (efr32xg2e, SDID 265).
 * @details Values match apps/sl_rail_test/config/efr32xg29/sl_rail_test_config.h (Lion);
 *          kept as a separate file so LionU can diverge without touching efr32xg29.
 *******************************************************************************
 * # License
