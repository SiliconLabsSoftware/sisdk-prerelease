...
static const sl_rail_ble_aox_antenna_port_pins_t antenna_port_pin[] = {
#ifdef SL_RAIL_UTIL_AOX_ANTENNA_PIN0_PORT
  {
    .antenna_port = (uint8_t)SL_RAIL_UTIL_AOX_ANTENNA_PIN0_PORT,
    .antenna_pin = SL_RAIL_UTIL_AOX_ANTENNA_PIN0_PIN
  },
#endif //SL_RAIL_UTIL_AOX_ANTENNA_PIN0_PORT
#ifdef SL_RAIL_UTIL_AOX_ANTENNA_PIN1_PORT
  {
    .antenna_port = (uint8_t)SL_RAIL_UTIL_AOX_ANTENNA_PIN1_PORT,
    .antenna_pin = SL_RAIL_UTIL_AOX_ANTENNA_PIN1_PIN
  },
#endif //SL_RAIL_UTIL_AOX_ANTENNA_PIN1_PORT
#ifdef SL_RAIL_UTIL_AOX_ANTENNA_PIN2_PORT
  {
    .antenna_port = (uint8_t)SL_RAIL_UTIL_AOX_ANTENNA_PIN2_PORT,
    .antenna_pin = SL_RAIL_UTIL_AOX_ANTENNA_PIN2_PIN
  },
#endif //SL_RAIL_UTIL_AOX_ANTENNA_PIN2_PORT
#ifdef SL_RAIL_UTIL_AOX_ANTENNA_PIN3_PORT
  {
    .antenna_port = (uint8_t)SL_RAIL_UTIL_AOX_ANTENNA_PIN3_PORT,
    .antenna_pin = SL_RAIL_UTIL_AOX_ANTENNA_PIN3_PIN
  },
#endif //SL_RAIL_UTIL_AOX_ANTENNA_PIN3_PORT
#ifdef SL_RAIL_UTIL_AOX_ANTENNA_PIN4_PORT
  {
    .antenna_port = (uint8_t)SL_RAIL_UTIL_AOX_ANTENNA_PIN4_PORT,
    .antenna_pin = SL_RAIL_UTIL_AOX_ANTENNA_PIN4_PIN
  },
#endif //SL_RAIL_UTIL_AOX_ANTENNA_PIN4_PORT
#ifdef SL_RAIL_UTIL_AOX_ANTENNA_PIN5_PORT
  {
    .antenna_port = (uint8_t)SL_RAIL_UTIL_AOX_ANTENNA_PIN5_PORT,
    .antenna_pin = SL_RAIL_UTIL_AOX_ANTENNA_PIN5_PIN
  },
#endif //SL_RAIL_UTIL_AOX_ANTENNA_PIN5_PORT
};
#endif //SL_RAIL_UTIL_AOX_ANTENNA_PIN_COUNT

static const sl_rail_ble_aox_antenna_config_t antenna_config = {
  ...
  .p_antenna_port_pin = (sl_rail_ble_aox_antenna_port_pins_t *)antenna_port_pin,
#endif //SL_RAIL_UTIL_AOX_ANTENNA_PIN_COUNT
  .antenna_count = SL_RAIL_UTIL_AOX_ANTENNA_PIN_COUNT
};

void sl_rail_util_aox_init(void)
{
  (void) sl_rail_ble_config_aox_antenna(SL_RAIL_EFR32_HANDLE, &antenna_config);
}
