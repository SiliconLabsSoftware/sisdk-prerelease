...
static const uint32_t phyInfo[] = {
  21UL,
  0x00199999UL, // 25.599999999999998
  (uint32_t) NULL,
...
SL_CODE_CLASSIFY(rail_lib, SL_CODE_CLASS_TIME_CRITICAL)
const uint32_t sl_rail_btc_phy_40MHz_modemConfigBase[] = {
...
SL_CODE_CLASSIFY(rail_lib, SL_CODE_CLASS_TIME_CRITICAL)
const RAIL_ChannelConfigEntry_t sl_rail_btc_phy_40MHz_channels[] = {
  {
...
SL_CODE_CLASSIFY(rail_lib, SL_CODE_CLASS_TIME_CRITICAL)
const RAIL_ChannelConfig_t sl_rail_btc_phy_40MHz_channelConfig = {
  .phyConfigBase = sl_rail_btc_phy_40MHz_modemConfigBase,
  .phyConfigDeltaSubtract = NULL,
  .configs = sl_rail_btc_phy_40MHz_channels,
  .length = 1U,
  .signature = 0UL,
