 ...
 *   Radio Configurator Version: 2604.1.0rc0
...
const uint32_t quuppa_viterbi1M_modemConfigBase[] = {
  ...
  0x01015020UL, 0x86000000UL,
  0x01064024UL, 0x0001C01FUL,
  /*    4028 */ 0x00006000UL,
  /*    402C */ 0x00008000UL,
  /*    4030 */ 0x03000000UL,
  /*    4034 */ 0x00000000UL,
...
const uint32_t ble_LR_DSA_125kb_modemConfig[] = {
  ...
  0x01016020UL, 0xFFDFFFFFUL,
  0x01015020UL, 0x46000030UL,
  0x01024024UL, 0x0001C81FUL,
  /*    4028 */ 0x10002000UL,
