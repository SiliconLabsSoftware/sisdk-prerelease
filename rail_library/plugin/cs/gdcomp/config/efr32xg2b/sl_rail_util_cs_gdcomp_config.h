...
// AGC_STATUS_0 goes from 0 to 33 i.e. 34 values,
// but we subtract 3 to get table index, so can do
// with 31 values in the table.
#define SL_RAIL_UTIL_CS_GDCOMP_TABLE_LENGTH 31U
