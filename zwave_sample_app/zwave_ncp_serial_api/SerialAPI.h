...
/* Installer API */
#define FUNC_ID_GET_NEIGHBOR_TABLE_LINE                 0x80
/** @deprecated Use FUNC_ID_GET_NEIGHBOR_TABLE_LINE */
#define FUNC_ID_GET_ROUTING_TABLE_LINE                  FUNC_ID_GET_NEIGHBOR_TABLE_LINE
/** @deprecated */
