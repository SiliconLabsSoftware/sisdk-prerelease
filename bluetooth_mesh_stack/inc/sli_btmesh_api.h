/***************************************************************************//**
 * @brief SL_BTMESH_API library at application layer provided as source code
 *******************************************************************************
 * # License
...
#ifndef SLI_BTMESH_API_H
#define SLI_BTMESH_API_H
...
// -----------------------------------------------------------------------------
// Class and command IDs for `btmesh` API
...
enum sli_btmesh_command_id
{
    ...
    sli_btmesh_node_test_proxy_beacon_command_id = 0x3c,
...
enum sli_btmesh_response_id
{
    ...
    sli_btmesh_node_test_proxy_beacon_response_id = 0x3c,
...
// -----------------------------------------------------------------------------
// Command and response structures for `btmesh` API
...
PACKSTRUCT( struct sl_btmesh_cmd_node_test_proxy_beacon_s
{
    uint16_t address;
    uint8array data;
});

typedef struct sl_btmesh_cmd_node_test_proxy_beacon_s sl_btmesh_cmd_node_test_proxy_beacon_t;
...
PACKSTRUCT( struct sl_btmesh_rsp_node_test_proxy_beacon_s
{
    uint16_t result;
    uint8_t match;
...
typedef struct sl_btmesh_rsp_node_test_proxy_beacon_s sl_btmesh_rsp_node_test_proxy_beacon_t;
...
// -----------------------------------------------------------------------------
// BGAPI message union for all message types of `btmesh` API
...
PACKSTRUCT( struct sl_btmesh_packet {
  ...
  union {
    ...
    sl_btmesh_cmd_node_test_proxy_beacon_t                       cmd_node_test_proxy_beacon;
    ...
    sl_btmesh_rsp_node_test_proxy_beacon_t                       rsp_node_test_proxy_beacon;
