...
sudo INFRA_IF_NAME=eth0 \
     ...
     OTBR_OPTIONS="-DOT_THREAD_VERSION=1.4 \
                   ...
                   -DOTBR_DHCP6_PD=ON \
                   -DOTBR_NAME=SL-OPENTHREAD-BR -DOTBR_VERSION=3.1.2.0_GitHub-717abf0dc -DOT_PACKAGE_NAME=SL-OPENTHREAD -DOT_PACKAGE_VERSION=3.1.2.0_GitHub-fb274efe6" \
     ./script/setup
...
#define OPENTHREAD_CONFIG_NET_DIAG_VENDOR_SW_VERSION "3.1.2.0"
