...
// <CS_ALGO_MODE_REAL_TIME_BASIC=> Real-time basic
// <CS_ALGO_MODE_STATIC_HIGH_ACCURACY=> Static high accuracy
// <CS_ALGO_MODE_REAL_TIME_FAST=> Real-time fast
// <i> Default: CS_ALGO_MODE_REAL_TIME_FAST
