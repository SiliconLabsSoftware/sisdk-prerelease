...
// <i> Set your custom connection and procedure intervals in the CS Manager
// <i> configuration: the 'Default procedure parameters' section in
// <i> cs_manager_cs_control_config.h and the 'Connection parameters' section in
// <i> cs_manager_config.h, when selecting
// <i> 'Use custom procedure scheduling' (CS_PROCEDURE_SCHEDULING_CUSTOM).
