/***************************************************************************//**
 * @file
 * @brief CS Configurator - optimization parameters
 *******************************************************************************
 * # License
...
#ifndef CS_CONFIGURATOR_OPTIMIZATION_INTERNAL_H
#define CS_CONFIGURATOR_OPTIMIZATION_INTERNAL_H
...
#define CS_CONFIGURATOR_RAS_DATA_BASE_US                      (12499UL)
...
// Empty connection events after measurement and before RAS for multiple peers
#define CS_CONFIGURATOR_EMPTY_BEFORE_RAS_CE_MULTIPLE_PEERS    (2U)
...
// The entire procedure time must exceed the estimation time
// by at least this many connection events
#define CS_CONFIGURATOR_DISTANCE_CALCULATION_PADDING_CE           (2U)

#endif // CS_CONFIGURATOR_OPTIMIZATION_INTERNAL_H
