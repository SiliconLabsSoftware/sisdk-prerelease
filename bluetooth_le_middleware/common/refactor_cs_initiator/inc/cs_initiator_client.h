...
// Main mode steps are ignored if submode is disabled.
// Default: 2 Range: 2-160
#define CS_INITIATOR_DEFAULT_MIN_MAIN_MODE_STEPS      2

// Default: 2 Range: 2-160
#define CS_INITIATOR_DEFAULT_MAX_MAIN_MODE_STEPS      2
