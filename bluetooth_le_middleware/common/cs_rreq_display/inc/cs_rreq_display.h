...
typedef enum {
  ...
  CS_RREQ_DISPLAY_STATUS_SCANNING,
  CS_RREQ_DISPLAY_STATUS_ESTIMATE,
  CS_RREQ_DISPLAY_STATUS_INITIALIZED,
  CS_RREQ_DISPLAY_STATUS_UNINITIALIZED,
  CS_RREQ_DISPLAY_STATUS_SPOOFED
...
typedef struct {
  ...
  cs_rreq_display_content_t content;
