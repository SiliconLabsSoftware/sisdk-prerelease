/***************************************************************************//**
 * @file
 * @brief CS Manager - CS Procedure control configuration
 *******************************************************************************
 * # License
...
// <o CS_MANAGER_DEFAULT_MAX_PROCEDURE_COUNT> Procedure count <1..65535>
...
// <CS_ANTENNA_CONFIG_INDEX_DUAL_LOCAL_SINGLE_REMOTE=> 2 antenna path, [2:1] antenna
// <CS_ANTENNA_CONFIG_INDEX_SINGLE_LOCAL_DUAL_REMOTE=> 2 antenna path, [1:2] antenna
