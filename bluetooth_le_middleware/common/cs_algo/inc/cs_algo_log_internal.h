...
#ifndef CS_ALGO_LOG_INTERNAL_H
#define CS_ALGO_LOG_INTERNAL_H

#include "sl_component_catalog.h"
#include "cs_algo_config.h"

#if defined(SL_CATALOG_APP_LOG_PRESENT) && CS_ALGO_CONFIG_LOG
#include "app_log.h"
#define LOG_PREFIX                  CS_ALGO_CONFIG_LOG_PREFIX " "
#define LOG_NL                      APP_LOG_NL
#define INSTANCE_PREFIX             "[%u] "
#define algo_log_wrap(code)         code
#else
#define algo_log_wrap(...)
#endif // defined(SL_CATALOG_APP_LOG_PRESENT) && CS_ALGO_CONFIG_LOG
