...
// The following 3 types are mirrored from cs_initiator headers so that
// cs_algo can be built without a direct dependency on cs_initiator. 
// TODO: relocate them cs_algo_api.h later (relates to ACP component)
...
#ifndef RTL_CONFIG_T_DEFINED
#define RTL_CONFIG_T_DEFINED
...
SL_PACK_END()
#endif // RTL_CONFIG_T_DEFINED

#ifndef CS_INTERMEDIATE_RESULT_T_DEFINED
#define CS_INTERMEDIATE_RESULT_T_DEFINED
typedef struct {
  float progress_percentage; 
  uint8_t connection;
} cs_intermediate_result_t;
#endif // CS_INTERMEDIATE_RESULT_T_DEFINED
