 ...
 * outcome (success / in-progress / error) to the cs_algo / app callbacks.
 *
                              ...
                              cs_rreq_result_t *ranging_data)
{
  ...
  // Set a pointer to the caller's unified ranging data so the result
  // callback can forward it to the app callbacks (used for extended result)
  inst->ranging_data = ranging_data;
