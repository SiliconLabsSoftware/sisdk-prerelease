...
// EUSART1 TX on PD02
#define SL_CPC_DRV_UART_VCOM_TX_PORT             SL_GPIO_PORT_D
#define SL_CPC_DRV_UART_VCOM_TX_PIN              2

// EUSART1 RX on PD03
#define SL_CPC_DRV_UART_VCOM_RX_PORT             SL_GPIO_PORT_D
#define SL_CPC_DRV_UART_VCOM_RX_PIN              3

// EUSART1 CTS on PD05
#define SL_CPC_DRV_UART_VCOM_CTS_PORT            SL_GPIO_PORT_D
#define SL_CPC_DRV_UART_VCOM_CTS_PIN             5

// EUSART1 RTS on PD04
#define SL_CPC_DRV_UART_VCOM_RTS_PORT            SL_GPIO_PORT_D
