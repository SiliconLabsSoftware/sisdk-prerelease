...
#include "em_device.h"
#if defined(_SILICON_LABS_32B_SERIES_3) || defined(_SILICON_LABS_32B_SERIES_2_CONFIG_11)
...
#if defined(_SILICON_LABS_32B_SERIES_2) && !defined(_SILICON_LABS_32B_SERIES_2_CONFIG_11)
