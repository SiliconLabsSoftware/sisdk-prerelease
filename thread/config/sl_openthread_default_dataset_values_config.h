...
// <a.8 SL_OPENTHREAD_DEFAULT_DATASET_EXTPANID> Default Dataset Extended PAN ID <0..255> <f.h>
// <d> {0xC0, 0xDE, 0x1A, 0xB5, 0xC0, 0xDE, 0x1A, 0xB5}
#define SL_OPENTHREAD_DEFAULT_DATASET_EXTPANID {0xC0, 0xDE, 0x1A, 0xB5, 0xC0, 0xDE, 0x1A, 0xB5}
