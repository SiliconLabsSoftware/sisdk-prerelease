...
while [[ $# -gt 0 ]]; do
    case $1 in
        -h|--help)
            ...
            echo -e "\t-G\tStart zigbee_gp_z3_gateway_cpc_combo application in the running multiprotocol container"
        ...
        -P|--pro-compliance)
            ...
            ;;
        -G|--gp-zigbee-cpc)
            echo "Starting zigbee_gp_z3_gateway_cpc_combo..."
            docker exec -it multiprotocol /usr/local/bin/zigbee_gp_z3_gateway_cpc_combo
            exit
            ;;
        -L|--bluetoothctl)
